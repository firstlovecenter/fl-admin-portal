/**
 * Tests for the i18n conversion of GovernorshipHistory.tsx.
 *
...
describe('GovernorshipHistory i18n keys', () => {
  ...
  it('resolves "Governorship" via shared.churchLevel for the audit-trail sentence', async () => {
    await i18n.changeLanguage('fr')

    expect(i18n.t('shared.churchLevel.Governorship')).toBe('Gouvernorat')
  })
})
