...
const FourOhFour = ({ className }: { className: string }) => {
  return (
    ...
    >
      ...
      <path d="M15.217 40.079c-.492 0-.983-.181-1.367-.55a1.97 1.97 0 01-.058-2.787c3.611-3.766 8.471-5.84 13.687-5.84 4.629 0 9.084 1.687 12.549 4.748a1.973 1.973 0 01-2.615 2.957 14.983 14.983 0 00-9.934-3.758 14.903 14.903 0 00-10.838 4.621 1.963 1.963 0 01-1.424.609z" />
