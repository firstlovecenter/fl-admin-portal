...
* **deps:**
  *  raise fast-xml-parser override to ^5.7.3 across packages ([77014d9d](https://github.com/firstlovecenter/fl-admin-portal/commit/77014d9dcb9ac98994396cc555249a9b098403db))
  *  override uuid to 11.1.1 across api, graphql lambda, webhook ([e2590387](https://github.com/firstlovecenter/fl-admin-portal/commit/e2590387202967cbfb4e68c9f12dd619d9ef6e03))
  *  move xlsx to patched SheetJS CDN build 0.20.3 ([993c7d74](https://github.com/firstlovecenter/fl-admin-portal/commit/993c7d74e5d57f7590c87c06b0fa7d7e66e9d69a))
  *  migrate to Apollo Server 5 ([56041bd3](https://github.com/firstlovecenter/fl-admin-portal/commit/56041bd34d570fe4bb7d364b5e801952c4ec6a1d))
  *  bump vite to 7 and vite-plugin-pwa to 1.3 ([ad7fb47c](https://github.com/firstlovecenter/fl-admin-portal/commit/ad7fb47c01794ddb28f38e5109d0981f71cbe92a))
  *  bump firebase-admin to 14 in payment-webhook ([7508f5a7](https://github.com/firstlovecenter/fl-admin-portal/commit/7508f5a7e7b883c789067611a71f7b2a8a93ff35))
  *  bump googleapis to 173 in background sheets jobs ([575bff96](https://github.com/firstlovecenter/fl-admin-portal/commit/575bff96f1b511f3eb60a2449c868898b6ffc5fc))
  *  drop dead firebase-admin and googleapis from api ([709a23d6](https://github.com/firstlovecenter/fl-admin-portal/commit/709a23d6dedafa31baaf640f0aaba2bdffac9459))
  *  drop dead prettier-eslint-cli devDependency ([08628728](https://github.com/firstlovecenter/fl-admin-portal/commit/08628728c72e101d7c52890b9de3f1ab659c3db3))
  *  drop dead axios dep from graph-aggregator lambdas ([2734f5f4](https://github.com/firstlovecenter/fl-admin-portal/commit/2734f5f4c567e83d162e8af725cc9591dd3b5837))
  *  patch Dependabot alerts via safe lockfile bumps ([84a1ef37](https://github.com/firstlovecenter/fl-admin-portal/commit/84a1ef37a03305442a3bd5ddedec5a01394b40c8))
  *  drop dead @as-integrations/aws-lambda dep (SYN-61 review fix) ([0b3d98e3](https://github.com/firstlovecenter/fl-admin-portal/commit/0b3d98e380c64f9328b0ad4e58d1b060f5b8ec21))
  *  bump high/critical Dependabot alerts across api + web (SYN-61) ([94490f03](https://github.com/firstlovecenter/fl-admin-portal/commit/94490f03a7f236aa1d2c6241cc4f17221bc5f9ca))
  *  remove @netlify/functions — no longer deploying to Netlify ([3d2be822](https://github.com/firstlovecenter/fl-admin-portal/commit/3d2be822e9acc3b2842a55de8284024b40a8e087))
  *  drop unused react-hook-form and shadcn form primitive ([f1512839](https://github.com/firstlovecenter/fl-admin-portal/commit/f1512839ca6d0c638266b07b1498e4e92ff35ca7))
* **web:**
  *  remove dead meta.json build-version generator ([f7d9778e](https://github.com/firstlovecenter/fl-admin-portal/commit/f7d9778e3a2b77739526c8c67e469e35b7c2e558))
  *  scaffold Vitest test infrastructure per ADR-013 ([aa887c36](https://github.com/firstlovecenter/fl-admin-portal/commit/aa887c360364e00ab310f1c0f9695dceff350b0a))
* **release:**  bump version to 9.0.0 ([2cb3ccf6](https://github.com/firstlovecenter/fl-admin-portal/commit/2cb3ccf6c0ca5334f4801e19b89b0dc7dbfbab01))
* **package-lock:**  remove unused nodemon dependencies ([ac1a8883](https://github.com/firstlovecenter/fl-admin-portal/commit/ac1a88832024dc974cb42c3965b5b85fa1388f72))
* **scripts:**
  *  add aggregate-bussing-record-id migration (SYN-149) ([2b99030a](https://github.com/firstlovecenter/fl-admin-portal/commit/2b99030af6347dd6318c7096b20232e41dbf2008))
  *  add dev-only historical aggregation backfill script ([a15df7ea](https://github.com/firstlovecenter/fl-admin-portal/commit/a15df7eaf4e8f1ba24394d78d9c121f8172a0ecd))
* **cypher:**  mirror SYN-150 prod uniqueness constraints ([91baacc8](https://github.com/firstlovecenter/fl-admin-portal/commit/91baacc81a055dcc7770abf044ef84dfc9abdd3b))
* **lambda:**  auto-load dev Neo4j creds for integration tests ([398ca70c](https://github.com/firstlovecenter/fl-admin-portal/commit/398ca70cc4d780a1578afd9b5597403401292287))
*  add root npm test script running api + web suites concurrently ([a9650419](https://github.com/firstlovecenter/fl-admin-portal/commit/a965041931976bd4ee7675c5a39f67ea8e63b715))
*  clean up .prettierrc.json by removing unnecessary whitespace ([ea4a081d](https://github.com/firstlovecenter/fl-admin-portal/commit/ea4a081da83d720bd84a2da51a5e7461705ece66))
*  remove @jaedag/admin-portal-types and -api-core packages ([8d4d99f2](https://github.com/firstlovecenter/fl-admin-portal/commit/8d4d99f21c06bfc4130ad6e0ba64487674cc84b7))
*  remove husky and commitlint dependencies from package.json ([8dbe88c4](https://github.com/firstlovecenter/fl-admin-portal/commit/8dbe88c4f1734fbc33f38b04b3550631e56c4bfb))
*  update version in meta.json and streamline npm commands in package.json ([17654e66](https://github.com/firstlovecenter/fl-admin-portal/commit/17654e66d456fdd419c1758a207ba2d059463839))
*  add .npmrc to .gitignore ([ec307323](https://github.com/firstlovecenter/fl-admin-portal/commit/ec30732344bc0b91e5eb885abaedbdc9a25b3ee2))
*  update meta.json version ([564e310a](https://github.com/firstlovecenter/fl-admin-portal/commit/564e310a6f24f9c05fe44ebb74b2a276edb21a77))
* **accounts:**  shared currency formatter + drop TS any (SYN-113 subset) ([3733e3b2](https://github.com/firstlovecenter/fl-admin-portal/commit/3733e3b238ac96e689cbc9de412c76612013d345))
* **banking-webhook:**  add seek indexes, document Paystack IPs, indirect secret name ([e18af738](https://github.com/firstlovecenter/fl-admin-portal/commit/e18af7386ecbbb784dd50f69f5a08f3f54cd001d))
* **claude:**
  *  repaint peacock with synago brand pink ([a4055cfd](https://github.com/firstlovecenter/fl-admin-portal/commit/a4055cfd834741ac61cb7338fe2f92775a0e2923))
  *  refresh code-reviewer rules and bypass permissions ([a3bfa75a](https://github.com/firstlovecenter/fl-admin-portal/commit/a3bfa75ac78f5630c619f6263d3b23f1bbecff8d))
  *  add jira-move skill for transitioning SYN tickets ([05a000f0](https://github.com/firstlovecenter/fl-admin-portal/commit/05a000f094b3549ecb073db841fda92ac3c4d32c))
  *  add jira-story-writer agent for SYN project ([d7e7fe9b](https://github.com/firstlovecenter/fl-admin-portal/commit/d7e7fe9b0fe56aa4b3e304de2631c4a3120a040a))
  *  update design command and remove unused asset ([9599270e](https://github.com/firstlovecenter/fl-admin-portal/commit/9599270e4320d4a61e1c4689b942850614b1fc6c))
  *  install Leonxlnx taste-skill definitions ([5f5c641b](https://github.com/firstlovecenter/fl-admin-portal/commit/5f5c641ba6b81f8ec24b5a3bc6f5aa1547455e12))
* **api:**  scaffold Jest test infrastructure per ADR-013 ([68d973b2](https://github.com/firstlovecenter/fl-admin-portal/commit/68d973b2b0160dd688bea1f5df30c0f00b961b6e))

##### Continuous Integration

*  trigger background functions Lambda redeploy ([6da69997](https://github.com/firstlovecenter/fl-admin-portal/commit/6da69997590449c94f1bb211eb2f29c269e53d83))
*  exclude test files from background lambda build ([f8d5cef0](https://github.com/firstlovecenter/fl-admin-portal/commit/f8d5cef0b0a6727b8e8a42a741452494dd297611))
*  trigger background functions Lambda redeploy ([02123da6](https://github.com/firstlovecenter/fl-admin-portal/commit/02123da6cf0a40c1f874c10625af878ad38b8258))
*  exclude test files from background lambda build ([c8a422e2](https://github.com/firstlovecenter/fl-admin-portal/commit/c8a422e2dcc603817ff5a1411d0251a4ff7e087b))
*  deploy api lambda from staging branch ([73b31869](https://github.com/firstlovecenter/fl-admin-portal/commit/73b318696295cdad5f2835b101e69f0513bf1ff0))
* **lambda:**
  *  trigger redeploy when the workflow itself changes ([f558e6ce](https://github.com/firstlovecenter/fl-admin-portal/commit/f558e6ce0d6fbdc322d9eee2dd66ba45f9f55b1e))
  *  fix tsc compile after llm-client moved into resolvers ([b7192cdc](https://github.com/firstlovecenter/fl-admin-portal/commit/b7192cdcecebe61866c2a437c54b21ff80fe3857))

##### Documentation Changes

* **claude:**
  *  defer changelog to generate-changelog instead of /commit ([da9bf3bb](https://github.com/firstlovecenter/fl-admin-portal/commit/da9bf3bbeb99b5aeb3707659f903ea7fd867178e))
  *  make /commit update the changelog on every commit ([19038172](https://github.com/firstlovecenter/fl-admin-portal/commit/190381726a127aed70ae429972a925eb90f8e0be))
  *  correct jira-move transition IDs for SYN board ([0472d823](https://github.com/firstlovecenter/fl-admin-portal/commit/0472d823013dcd10a587e10f0b8b9887de6dd80a))
  *  clarify engineer-only testing for back-end-only stories ([0e55b631](https://github.com/firstlovecenter/fl-admin-portal/commit/0e55b631b087d196a92be29d197f3d6b4aa40ed6))
  *  add mandatory Testing Scenario section to jira-story-writer ([37985998](https://github.com/firstlovecenter/fl-admin-portal/commit/379859982b62ce92c4e094d5857638d0fb078e0a))
  *  scope /commit to current-session work by default ([5936c253](https://github.com/firstlovecenter/fl-admin-portal/commit/5936c2539fe30c026003ad402db468e1f1e869bb))
* **kb:**
  *  document denomination leader gate and aggregate dedup ([4074d352](https://github.com/firstlovecenter/fl-admin-portal/commit/4074d352273b47a22eaa1947e92cb299a2eda3d4))
  *  record SYN-153 aggregation completeness learnings ([f0ece989](https://github.com/firstlovecenter/fl-admin-portal/commit/f0ece989569cc5895e57774f6a870d770fc4e479))
  *  update ADR-001 with shared fixture reference (SYN-63) ([d92b4eb2](https://github.com/firstlovecenter/fl-admin-portal/commit/d92b4eb240e444fbc2dbcee63a89d51989a7d24e))
  *  drop stale download-credits references after folder rename ([db522f2b](https://github.com/firstlovecenter/fl-admin-portal/commit/db522f2be9d51fcf8dfdfb4c72f78c043d19976a))
  *  rename constituency test account to governor/governorship ([79270917](https://github.com/firstlovecenter/fl-admin-portal/commit/792709170845f963d3eaa4b75951ea2fad93c2ce))
  *  deprecate Bootstrap fully — every touched file must migrate ([047ca0bd](https://github.com/firstlovecenter/fl-admin-portal/commit/047ca0bdbd9dc5b7103ba7cf98393bf8b1a5931e))
  *  update glossary — Bacenta is now the leaf node ([5b5ffcda](https://github.com/firstlovecenter/fl-admin-portal/commit/5b5ffcda0a190154345515ddc762bf4b8995c3fd))
* **arrivals:**  clarify SM5 actor matrix + SoD on SendVehicleSupport (SYN-119) ([4659abce](https://github.com/firstlovecenter/fl-admin-portal/commit/4659abce2949538e5f0763a91ef91a7b3dbf2032))
* **services:**  pin permitLeaderAdmin gate on RecordService (SYN-125) ([3d6f3f8f](https://github.com/firstlovecenter/fl-admin-portal/commit/3d6f3f8f93f6494124dbea590fd0a6956eb565bf))
*  fix TESTING.md factual claims and ADR-013 drift ([bc1d1b79](https://github.com/firstlovecenter/fl-admin-portal/commit/bc1d1b79ec43d631391bafaf8e5ce5b8b66fdece))
*  update testing guidelines and add operational guide ([a9f8b6d1](https://github.com/firstlovecenter/fl-admin-portal/commit/a9f8b6d17eca22c9a73e6f2b07ff7cb14ddfba96))
*  tighten neo4j-prod MCP usage rules ([eafbd35b](https://github.com/firstlovecenter/fl-admin-portal/commit/eafbd35bb7d4eaf32fd717937748f46f133a59fc))

##### New Features

* **services:**
  *  show Oversight/Denomination income in USD ([1b126fde](https://github.com/firstlovecenter/fl-admin-portal/commit/1b126fde5bec798c8cf78b5e568df52cef551184))
  *  enforce current-week serviceDate on every recording resolver ([5bf52e87](https://github.com/firstlovecenter/fl-admin-portal/commit/5bf52e87ae6677fc5fc2e9f31c68a6195f2cd95e))
  *  add stream-by-governorship drill-down for defaulters ([9411dee2](https://github.com/firstlovecenter/fl-admin-portal/commit/9411dee26b1024d1e12e736d3c08688a68ab5b0f))
  *  hide self-banking pay for manual-banking churches ([2d6f95df](https://github.com/firstlovecenter/fl-admin-portal/commit/2d6f95df1a264f5c0ec3ee57d3bad27906e2a03d))
  *  apply 2-col layout and PWA back button to defaulters report page ([b26048ba](https://github.com/firstlovecenter/fl-admin-portal/commit/b26048bab5e5c5cdff1cbf244b872f6cf56c7f77))
  *  use 2-col desktop layout on defaulters dashboard ([07611115](https://github.com/firstlovecenter/fl-admin-portal/commit/076111156fa6a78b34984dc38cbad6d053836123))
  *  redesign defaulters week pages with shared totals card ([85ee9085](https://github.com/firstlovecenter/fl-admin-portal/commit/85ee9085239c43ffd63397f8973650f02aba6b27))
  *  link active bacentas tile to bacentas directory list ([13c0b5dc](https://github.com/firstlovecenter/fl-admin-portal/commit/13c0b5dcc7975bd9abf418c46c1453514b04bbb4))
  *  redesign defaulters dashboard and wire to church in focus ([6c2425d4](https://github.com/firstlovecenter/fl-admin-portal/commit/6c2425d4ed496fd060ea5203975248a36c9cbdb8))
  *  clarify joint service wording above congregation level ([fd3a175f](https://github.com/firstlovecenter/fl-admin-portal/commit/fd3a175f6f34160bf7313f89eb6c96d99bab7345))
  *  redesign defaulter card and add denomination query ([ba4a030b](https://github.com/firstlovecenter/fl-admin-portal/commit/ba4a030b67b780aae073e188de1582b2d06e5fe5))
  *  enhance ServiceDetails and ServiceDetailsNoIncome components with improved layout and action visibility ([9cfe7ea1](https://github.com/firstlovecenter/fl-admin-portal/commit/9cfe7ea1ccdb5c9226b1a94a3ef0037eddee48cb))
  *  redesign services menu, forms, and detail pages with shadcn/ui ([b9a83167](https://github.com/firstlovecenter/fl-admin-portal/commit/b9a8316792a184f992bf4bd0dc090c9ed761132f))
  *  redesign bacenta graphs and modernize ChurchGraph ([e97742b2](https://github.com/firstlovecenter/fl-admin-portal/commit/e97742b2f7af52f1d80dc09786e5d070ab25f54b))
  *  redesign trends menu with shadcn and church-in-focus ([fabe9ab6](https://github.com/firstlovecenter/fl-admin-portal/commit/fabe9ab68eca171afc1fddd3b11c779afe9e4b83))
* **infra:**  add Terraform adopting live AWS core-portal infra ([90690181](https://github.com/firstlovecenter/fl-admin-portal/commit/906901819c0bf5cf17ef3c17ad2476c3f789a78a))
* **ci:**  add GitHub Actions test workflows for FE + BE (SYN-83) ([f9692235](https://github.com/firstlovecenter/fl-admin-portal/commit/f96922353598bd5a27f1abb745d30732555bdebe))
* **arrivals:**
  *  quick stream switcher on bacentas-to-count page (SYN-154) ([ba2a6df1](https://github.com/firstlovecenter/fl-admin-portal/commit/ba2a6df1a8fdb53d17bcdcb4dd69ce78edf81c81))
  *  non-repeating cycle for code-of-the-day pool ([97cb1793](https://github.com/firstlovecenter/fl-admin-portal/commit/97cb17934a7519242427a9048170aa29cf1f946b))
  *  swap code-of-the-day pool for curated list + restore manual set ([72c646a7](https://github.com/firstlovecenter/fl-admin-portal/commit/72c646a7f72e4f586662b8b3d4db566716ea036d))
  *  migrate breakdown pages to compact expandable rows ([a3895094](https://github.com/firstlovecenter/fl-admin-portal/commit/a38950947eabc99952c2a5fe7cf6c3f1b8b60b7a))
  *  redesign dashboards with week selector and mobile tabs ([241a5e6d](https://github.com/firstlovecenter/fl-admin-portal/commit/241a5e6dd54f1071f971f0c07b18b91e3ad7a07f))
  *  redesign stream arrival times with inline edit modal ([0f5b0bfd](https://github.com/firstlovecenter/fl-admin-portal/commit/0f5b0bfdce9e2d20e3d1f690c49c6bfea6ac67e0))
  *  navigate only to dates with bussing data ([82aee6e9](https://github.com/firstlovecenter/fl-admin-portal/commit/82aee6e9e200e074e7ed237758f4d6b770ae10bd))
  *  update streamId handling in ArrivalsPaymentData component ([c3e15926](https://github.com/firstlovecenter/fl-admin-portal/commit/c3e15926a73a6122b6229e3446bc8bc7e8bfcc9b))
  *  group council bacenta status by governorship in accordion ([6ebd7a08](https://github.com/firstlovecenter/fl-admin-portal/commit/6ebd7a087166a6ec30c4369075855c1480e3a593))
  *  add date switcher and downloadable list ([47535038](https://github.com/firstlovecenter/fl-admin-portal/commit/4753503852e515d8c4ad40c3a756f56541b8c321))
  *  extract BacentaListSkeleton component ([4899807a](https://github.com/firstlovecenter/fl-admin-portal/commit/4899807a9d6639d5be5c133ee9f567bd4ce5b5e4))
  *  paginate arrivals payment data ([a3401466](https://github.com/firstlovecenter/fl-admin-portal/commit/a340146668ec11bf7e98cd0e8d3141ed478a7e50))
  *  redesign arrivals pages and fix bussing state detection ([fb39e5bd](https://github.com/firstlovecenter/fl-admin-portal/commit/fb39e5bd3ca1bc3d8a222bec5cdf363f5d56d782))
* **banking:**
  *  stream teller dashboard, council coverage, search ([72b9902c](https://github.com/firstlovecenter/fl-admin-portal/commit/72b9902c6367ae943851cc25357040f960632954))
  *  stamp bankingMethod on ServiceRecord at confirmation ([d94ef7b8](https://github.com/firstlovecenter/fl-admin-portal/commit/d94ef7b8c2b6695056a9fe509806ea13971af69f))
  *  audit log, admin recovery flow, and IDOR closure ([563e4e36](https://github.com/firstlovecenter/fl-admin-portal/commit/563e4e36c9709d5526c43605a06d179867558744))
  *  gate test-mode payments on SECRETS.ENVIRONMENT=development ([eeb5490e](https://github.com/firstlovecenter/fl-admin-portal/commit/eeb5490ee69d82eded94468335a9628957a1694c))
* **reports:**
  *  extend picker pattern to defaulters and arrivals ([c16cb150](https://github.com/firstlovecenter/fl-admin-portal/commit/c16cb150dd5448a746354739f08e9adc4b223231))
  *  apply-button pattern, skeleton, and click fixes for picker ([dad3617e](https://github.com/firstlovecenter/fl-admin-portal/commit/dad3617e2645d785f62c2294a7b3f0f3cb66a101))
  *  pick row level + ancestor columns for sub-church metrics ([6e1ddcd6](https://github.com/firstlovecenter/fl-admin-portal/commit/6e1ddcd6341c2077287d64f90f3fb6be42e06c8e))
  *  enrich directory CSV + by-sub-church pages ([c147cf3c](https://github.com/firstlovecenter/fl-admin-portal/commit/c147cf3c6d642b39d5e825ed92c982e8d68b457e))
  *  add arrivals preview and unify download to dialog/drawer ([966dfecf](https://github.com/firstlovecenter/fl-admin-portal/commit/966dfecf8828224a73af60aeefd321094a6f7fe9))
  *  add lat/lng to directory CSV export ([90d9954e](https://github.com/firstlovecenter/fl-admin-portal/commit/90d9954e84f6fc87f2adcca81a8464ed315a9554))
  *  restructure landing and add bacenta service-record detail ([77c2fa8c](https://github.com/firstlovecenter/fl-admin-portal/commit/77c2fa8c59f2fd23649a0569be7b4cafd24d1c28))
  *  add directory, services, income & sub-church downloads ([53e12f0e](https://github.com/firstlovecenter/fl-admin-portal/commit/53e12f0e816c0b2196e7573432ed88a41c78924f))
  *  add ReportsPage and routing for membership downloads ([297eb4cf](https://github.com/firstlovecenter/fl-admin-portal/commit/297eb4cf17b5f2de0fb7fa54251456c5ef51dc71))
* **web:**
  *  extract StickyPageHeader to reserve mobile toggle space ([8fc46fa0](https://github.com/firstlovecenter/fl-admin-portal/commit/8fc46fa09532ec9c4e49a0b6d773bf269b438a48))
  *  show per-card pending spinner on reports navigation ([327e3c07](https://github.com/firstlovecenter/fl-admin-portal/commit/327e3c07c6a5a4240ec0390d4cc46657d8c4f75d))
  *  add sticky table of contents to reports page ([d35a34d8](https://github.com/firstlovecenter/fl-admin-portal/commit/d35a34d808500164d406961e8e782dea30c0fb7d))
  *  rebrand FLC servants portal to Synago ([c3fddf2c](https://github.com/firstlovecenter/fl-admin-portal/commit/c3fddf2c872228857e166f784d9166bed4ff2233))
  *  add drag-and-drop support to ImageUpload ([67b2b7d9](https://github.com/firstlovecenter/fl-admin-portal/commit/67b2b7d9af86b54bc38b6e14f811a52feb2eaca2))
  *  add drag-and-drop support to image upload component ([6faf9222](https://github.com/firstlovecenter/fl-admin-portal/commit/6faf922286d169bdb69a959b8b8ef0c1688b2390))
  *  include church name and sub-church type on report cards ([1ad37138](https://github.com/firstlovecenter/fl-admin-portal/commit/1ad37138a5934dbb8be06881fd3051b97155442f))
  *  scope reports cards to current church name ([99e2e844](https://github.com/firstlovecenter/fl-admin-portal/commit/99e2e844c3bccadc6cae1e6eda104018a9ac50cb))
  *  wire global search palette and remove legacy search ([d5f900b1](https://github.com/firstlovecenter/fl-admin-portal/commit/d5f900b1ad149a90798e6df07bb63198b4cf64aa))
  *  add show-more toggle to global search palette ([79d7606f](https://github.com/firstlovecenter/fl-admin-portal/commit/79d7606f9b2211026974b53ea9bb860412a6bddc))
  *  add admin-gated shepherding control sidebar entry ([5bbbb593](https://github.com/firstlovecenter/fl-admin-portal/commit/5bbbb593d34e401f7e3abff0c8d541d53536e97a))
  *  add infinite-scroll hook and apollo cache factory ([a6c11ea8](https://github.com/firstlovecenter/fl-admin-portal/commit/a6c11ea885057767dc6fcac19f7035c976530eb4))
  *  add settings page and migrate toasts to sonner ([e7691de9](https://github.com/firstlovecenter/fl-admin-portal/commit/e7691de98eedadab1f14a48aa8c5e8e84065e15f))
  *  add PWA standalone back button to AppShell ([f9948ca3](https://github.com/firstlovecenter/fl-admin-portal/commit/f9948ca3319eef28b74e5c95b0701c3ca69d7ed9))
  *  redesign searchable combobox with shadcn cmdk + popover ([a50a0055](https://github.com/firstlovecenter/fl-admin-portal/commit/a50a0055dab3230b1dc41b2ef42c244fd55d3f19))
  *  add entry and stagger animations to sidebar nav ([a0e89481](https://github.com/firstlovecenter/fl-admin-portal/commit/a0e89481c5d94d21b6300c600a671f72081e3ea0))
* **downloads:**
  *  add sub-church column picker to membership CSV export ([2c0a8aa2](https://github.com/firstlovecenter/fl-admin-portal/commit/2c0a8aa2ae3b016d4c2c4c3736426ca6e0b4c725))
  *  implement membership download functionality with CSV export ([da32d9f3](https://github.com/firstlovecenter/fl-admin-portal/commit/da32d9f39f3c3cb12aec47ba994ae89dcebef5a3))
* **directory:**
  *  replace pastoral title page with dialog and per-title remove ([7a043f8c](https://github.com/firstlovecenter/fl-admin-portal/commit/7a043f8c48f99088db7cd9cdbeb3fbc52e29fe46))
  *  denominational member browsing + CSV download ([b86017d4](https://github.com/firstlovecenter/fl-admin-portal/commit/b86017d4892aa03c90f21ea96dc2555b5791fc6d))
  *  uniform hierarchy breadcrumb across all All* list pages ([1f77c467](https://github.com/firstlovecenter/fl-admin-portal/commit/1f77c4678ab4670d96e31e31b81c229f652a13fa))
  *  add hierarchy breadcrumb to campus governorships page ([889a7fad](https://github.com/firstlovecenter/fl-admin-portal/commit/889a7fadca77d56098d7e386ce9f94d9ee742e64))
  *  append church level label to names in hierarchy list pages ([85a28a87](https://github.com/firstlovecenter/fl-admin-portal/commit/85a28a87c30a5f3af9b1118e4ca033594f1e3a28))
  *  add campus councils page and update members heading ([24f0e2c5](https://github.com/firstlovecenter/fl-admin-portal/commit/24f0e2c56be6f9a4661622acaa7f864adaf5ff06))
  *  surface arrivals and teller roles on member display ([bdc8d89b](https://github.com/firstlovecenter/fl-admin-portal/commit/bdc8d89b5b5a09e7fc92d2956d0b6e862f90888a))
  *  make pastors count clickable to filter members by pastor title ([ba95c017](https://github.com/firstlovecenter/fl-admin-portal/commit/ba95c017be8fbb35749aa8357ef802fc0f8375d3))
  *  migrate council/stream/campus quick facts to shadcn ([ee32705c](https://github.com/firstlovecenter/fl-admin-portal/commit/ee32705c20134ccca810e9a7828e317981f8f4a9))
  *  add council-level bacenta view with category split ([bb2db266](https://github.com/firstlovecenter/fl-admin-portal/commit/bb2db2669d717c08fb6f9af13959d72edf830a74))
  *  wire pastors tile and lift detail cards on hover ([291f5ee7](https://github.com/firstlovecenter/fl-admin-portal/commit/291f5ee72b78cafcf95cd52d4d5b6a3a6010ec8e))
  *  migrate governorship list to shadcn, add bacenta search ([705251cb](https://github.com/firstlovecenter/fl-admin-portal/commit/705251cbe1965b2cc09aec561e9d6be9484e4df9))
  *  restore delete UI on member details page ([96c2586e](https://github.com/firstlovecenter/fl-admin-portal/commit/96c2586e3adfc1f54fa2c5df925f46875c839f75))
  *  show church admin alongside leader avatar ([37f7dbbb](https://github.com/firstlovecenter/fl-admin-portal/commit/37f7dbbbe4cb33ab206c921ddcc02377b659d2f6))
  *  add close-down button on bacenta display page ([755e8d16](https://github.com/firstlovecenter/fl-admin-portal/commit/755e8d1681886cb877f494afbacea702529fffd7))
  *  add membership download button to members grid ([a21764d1](https://github.com/firstlovecenter/fl-admin-portal/commit/a21764d14c96f9f840e345ad25f45389a0f2f66c))
  *  prompt bacenta leaders to record or cancel service ([212d9f3d](https://github.com/firstlovecenter/fl-admin-portal/commit/212d9f3da80dc1caea67d50841240c8e42a060d7))
  *  migrate governorship quick facts to Shadcn/Tailwind ([a9316206](https://github.com/firstlovecenter/fl-admin-portal/commit/a931620648281f99ab12f2fad16d9c2004c74e5d))
  *  expose treasurer name/picture in avg-weekday query ([4b43d6c6](https://github.com/firstlovecenter/fl-admin-portal/commit/4b43d6c64b92afe392128a9fbad244c1fda86c18))
  *  preview rows + drop self from sub-churches directory ([d23af18c](https://github.com/firstlovecenter/fl-admin-portal/commit/d23af18c23d12f1cf59fc1b066889507e2e3d23c))
  *  server-side pagination + filters for member grids ([bb1ce647](https://github.com/firstlovecenter/fl-admin-portal/commit/bb1ce6476329de2499c2f85c250587d23018757b))
  *  move membership download into members grid modal ([8a697156](https://github.com/firstlovecenter/fl-admin-portal/commit/8a697156da023324859400b279427028808fb71e))
  *  redesign bacenta quick-facts page with shadcn/ui ([697cd6de](https://github.com/firstlovecenter/fl-admin-portal/commit/697cd6deabd63180d221f938bd6b136a73a09294))
  *  redesign member form with Shadcn/UI + Tailwind ([ab3551aa](https://github.com/firstlovecenter/fl-admin-portal/commit/ab3551aa82995b55a811e50141f935327aeba952))
  *  redesign member display page with Shadcn/UI + Tailwind ([a53ce5e0](https://github.com/firstlovecenter/fl-admin-portal/commit/a53ce5e05dfac7de33d228b78fc7be07ced66df6))
  *  redesign church history timeline with aceternity beam ([7ed6cb7f](https://github.com/firstlovecenter/fl-admin-portal/commit/7ed6cb7ff23bdc3d1d3d1159cd758d36780ea6f3))
  *  migrate directory components to Shadcn/UI + Tailwind ([aeac29e3](https://github.com/firstlovecenter/fl-admin-portal/commit/aeac29e32772e15524ee30aeb6de99c68220bdc1))
* **dashboards:**
  *  scope dashboard around Stream Arrivals Counter role ([8d7eb76d](https://github.com/firstlovecenter/fl-admin-portal/commit/8d7eb76d346549bc614497b985e1b773c12a87ec))
  *  move tip of week to top on mobile + show recommended chapter ([903f35de](https://github.com/firstlovecenter/fl-admin-portal/commit/903f35de7a51e2ef382b88704ad1dd5859239301))
  *  rotate greetings hourly by time-of-day bucket ([b8f7a807](https://github.com/firstlovecenter/fl-admin-portal/commit/b8f7a807455ce56e6fbfbed77f8c17c3ef784d1f))
  *  show bussing/weekday toggle on every level ([20290093](https://github.com/firstlovecenter/fl-admin-portal/commit/20290093c4149dd6e78e96571b1231086bb48d21))
  *  add church details shortcut to mobile drawer ([a6d71e90](https://github.com/firstlovecenter/fl-admin-portal/commit/a6d71e90b86a1ca09cedf4eccda0971cafec36a2))
  *  accent user first name in dashboard greeting ([657231fe](https://github.com/firstlovecenter/fl-admin-portal/commit/657231fedbcf3c6034b4e3459f5376d9f1979d30))
  *  redesign user dashboard with 2-column layout ([9e702faa](https://github.com/firstlovecenter/fl-admin-portal/commit/9e702faa8a2e6bf98bdc83fe051ae4eb686fd6b7))
  *  pin quick actions to sticky sidebar on desktop ([cac34c4e](https://github.com/firstlovecenter/fl-admin-portal/commit/cac34c4ef508771bf42511134e68806216a0fe6d))
*  ai assistant chat history + redesigned weekly tip card ([e4e596d2](https://github.com/firstlovecenter/fl-admin-portal/commit/e4e596d2b5dfa952a3ebc3b9d62626e57679c4b8))
*  ai assistant phase 1 — knowledge base + weekly tip widget ([73878636](https://github.com/firstlovecenter/fl-admin-portal/commit/73878636c338a6e56063722cce7c719aed293e59))
*  add TanStack Table column sorting to arrivals and report preview tables ([562161a2](https://github.com/firstlovecenter/fl-admin-portal/commit/562161a20c38e18bdd00680c3215fea71073a2af))
*  redesign service graphs and arrivals state pages ([f4fd04c1](https://github.com/firstlovecenter/fl-admin-portal/commit/f4fd04c1fe92c3faddac4bad525df400ad664e48))
*  Refactor DisplayChurchDetails component for improved layout and functionality ([2c92698a](https://github.com/firstlovecenter/fl-admin-portal/commit/2c92698acbbe7df1be4ff5c068c0e6ec0a30a768))
*  enhance user and church data queries with currency and income tracking fields ([8a050ea9](https://github.com/firstlovecenter/fl-admin-portal/commit/8a050ea9fd9b308af87926c5845e817fbf88f50f))
*  add Tabs and Tooltip components for UI consistency ([962b73fd](https://github.com/firstlovecenter/fl-admin-portal/commit/962b73fde6aaf5b6c1a5a102c3561ac7c5f7b740))
*  transition to Shadcn/UI + Tailwind CSS for UI components ([dcc0fa93](https://github.com/firstlovecenter/fl-admin-portal/commit/dcc0fa93f0cdef3b219a8a4afc0fd942b88dc3b5))
*  update code-reviewer requirements and enhance security audit documentation ([94be99b9](https://github.com/firstlovecenter/fl-admin-portal/commit/94be99b9e96cbd35acc2a42c7cc80890a8e572d3))
*  add frontend conventions and design system documentation for web-react-ts ([1fa319fa](https://github.com/firstlovecenter/fl-admin-portal/commit/1fa319fac5044d3deaeda20d705316793c67dd67))
*  Add .mcp.json to .gitignore to prevent tracking of configuration files ([fb4730d5](https://github.com/firstlovecenter/fl-admin-portal/commit/fb4730d53181b3d29392dcb180516df1e282078d))
*  Enhance date handling with utility functions for ISO date conversion and normalization ([94238a67](https://github.com/firstlovecenter/fl-admin-portal/commit/94238a6754fded6be7fc1d0bc5f58cde2dee1e49))
*  Add getWeekdayDate function to calculate the following Monday from last Sunday ([828f11fc](https://github.com/firstlovecenter/fl-admin-portal/commit/828f11fc6c402f2ffd23e8c7d2c0ea4dbe00745d))
*  Add CLAUDE.md for project documentation and memory file ([9f9fce0b](https://github.com/firstlovecenter/fl-admin-portal/commit/9f9fce0b6d8cb7a167dc05c460a9acf18c814a2f))
*  Add service aggregation script with command line options and Neo4j integration ([30985dbb](https://github.com/firstlovecenter/fl-admin-portal/commit/30985dbb5f847525b022b979ff26db0ab5ae827e))
*  Add getWeekdayDate function to calculate the following Monday from last Sunday ([9ff6832d](https://github.com/firstlovecenter/fl-admin-portal/commit/9ff6832dcbed21962f0b7906eee782eb95da9482))
*  Add CLAUDE.md for project documentation and memory file ([cc220aad](https://github.com/firstlovecenter/fl-admin-portal/commit/cc220aadedb1a59b45ac40dfa61bf38b2b926480))
*  Add service aggregation script with command line options and Neo4j integration ([2bf24626](https://github.com/firstlovecenter/fl-admin-portal/commit/2bf24626265e878f07267477f71c7d6ef8125679))
*  Refactor report generation and CSV handling for Outside Accra Weekly updates ([2a976541](https://github.com/firstlovecenter/fl-admin-portal/commit/2a976541d1d56e53449ccb5ed80c1e89937bdd71))
*  Refactor report generation and CSV handling for Outside Accra Weekly updates ([66b27e0f](https://github.com/firstlovecenter/fl-admin-portal/commit/66b27e0f88b6af55c8ab4914f1b75d06ae34f286))
*  Add resolvers for meeting day and campus streams in Stream and Campus types ([21a530c4](https://github.com/firstlovecenter/fl-admin-portal/commit/21a530c4a12db2ebd6442d12290f501480ec85df))
*  Enhance email notification system for servant promotions and removals ([9b5dd6c9](https://github.com/firstlovecenter/fl-admin-portal/commit/9b5dd6c9103ba968bb37c3a652909e455fe244a2))
*  add VITE_AUTH_API_URL to environment variables and update auth service to validate its presence ([86033a6e](https://github.com/firstlovecenter/fl-admin-portal/commit/86033a6ed4f59ac07dab7b919019843fd8f71203))
*  add AWS Amplify deployment guide and remove outdated migration and configuration documents ([9e3472f1](https://github.com/firstlovecenter/fl-admin-portal/commit/9e3472f101f3848aa8927a914b18252a24681d14))
*  add AWS Amplify configuration and migration documentation for frontend deployment ([79202860](https://github.com/firstlovecenter/fl-admin-portal/commit/79202860442d3ff2fda8b2c6dcb32ee00d14ba17))
*  migrate React frontend from Netlify to AWS Amplify with build configuration ([1012bc12](https://github.com/firstlovecenter/fl-admin-portal/commit/1012bc12cbdccc10cc340aa08d9eedb284108943))
*  enhance AWS Lambda deployment workflow with dynamic target determination and improved Slack notifications ([e146b0d5](https://github.com/firstlovecenter/fl-admin-portal/commit/e146b0d5cc60b9669c300b955458ee8bfdee0e58))
*  update deployment branch to main and enhance logging in various components ([bed41161](https://github.com/firstlovecenter/fl-admin-portal/commit/bed411616b93b8ce15d5259f41e80619ad534e41))
*  add tuesday and wednesday as stream service days ([df26c010](https://github.com/firstlovecenter/fl-admin-portal/commit/df26c0101b75ea34d42ea9133cff28fc8b1ea015))
*  add Copilot instructions for First Love Church Admin Portal ([47947edc](https://github.com/firstlovecenter/fl-admin-portal/commit/47947edc33acf28ee506afafdb1435467847fbd9))
*  add 'dev' script to run development server with Doppler ([2db8b269](https://github.com/firstlovecenter/fl-admin-portal/commit/2db8b269c7cb583659e8fc445f44573431942d05))
*  add initial configuration for Neo4j server in mcp.json ([92bf8e42](https://github.com/firstlovecenter/fl-admin-portal/commit/92bf8e421d0cfe753ff3baa16c87f88350194c14))
*  add dollarIncome field to OVERSIGHT_GRAPHS query ([78b65e41](https://github.com/firstlovecenter/fl-admin-portal/commit/78b65e410e4bc155fcb28f71c693ba87bebcacf8))
*  add queries for campus and weekday banked and not banked income ([4fd098cb](https://github.com/firstlovecenter/fl-admin-portal/commit/4fd098cbb6f673056ce4f75eee5e1f1c4b9f3f3b))
*  add weekday and bussing society balance to transaction history ([7cf3f6b3](https://github.com/firstlovecenter/fl-admin-portal/commit/7cf3f6b3ee520c88fb1fa22de3b297c35282357b))
*  add Bacenta admin and deputy leader management in GraphQL schema and UI ([8068c772](https://github.com/firstlovecenter/fl-admin-portal/commit/8068c772cced7eda599e12ca62ebc4a0b5a23371))
* **accounts:**
  *  migrate CampusDashboard to Shadcn/UI + extract shared DashboardCards ([195951be](https://github.com/firstlovecenter/fl-admin-portal/commit/195951be3db787871e6e87999f4f29663240b837))
  *  migrate CampusCouncilList to Shadcn/UI + Tailwind ([871a5d6f](https://github.com/firstlovecenter/fl-admin-portal/commit/871a5d6f5fc5e345f38b0f93c2edbda950e0ad36))
  *  redesign module and harden mutations with auth + audit ([1c9d1f03](https://github.com/firstlovecenter/fl-admin-portal/commit/1c9d1f03133466193647f4999bbbd9ff659e0ac1))
  *  add column sorting to transaction history table ([7660cbf9](https://github.com/firstlovecenter/fl-admin-portal/commit/7660cbf9cd096483083a35ccce3ac63bb1d1feed))
  *  enhance AccountsLandingPage with council selection and loading states ([44de2214](https://github.com/firstlovecenter/fl-admin-portal/commit/44de22140aa8148a7746aadf106bb1f9e2aaf430))
  *  paginate transaction history pages ([f3b4b5bb](https://github.com/firstlovecenter/fl-admin-portal/commit/f3b4b5bb2a67e90d1cf2a48904fdc3a50a75cfe2))
* **auth:**
  *  per-church authority model + close David Dag IDOR ([d951bf26](https://github.com/firstlovecenter/fl-admin-portal/commit/d951bf26ecf0e0a08499ed40f88afec25467427a))
  *  remove jwt-decode dependency and enhance JWT verification handling ([6cd06a12](https://github.com/firstlovecenter/fl-admin-portal/commit/6cd06a1295717046fb3e4685108472bc93c5e9ea))
  *  replace jwtDecode with custom verifyJwt for enhanced JWT validation feat(permissions): update permission checks to use permitLeaderAdmin for sensitive actions test(verifyJwt): add unit tests for JWT verification logic and edge cases ([9daba48d](https://github.com/firstlovecenter/fl-admin-portal/commit/9daba48d6c110a52f9aa371ff41de1515f5393fc))
  *  migrate login flow to Shadcn/UI + Tailwind with dark mode ([85a34719](https://github.com/firstlovecenter/fl-admin-portal/commit/85a34719b04a10bdf38f90ad75230badc67f4293))
  *  remove unused authentication pages and add version display to login and setup password pages ([525782b9](https://github.com/firstlovecenter/fl-admin-portal/commit/525782b9453500e2e5ff83b8699136c022cecbea))
  *  enhance token management with detailed logging and error handling ([257ccf65](https://github.com/firstlovecenter/fl-admin-portal/commit/257ccf6531cf8bbbb3bed23d7fd6b8ad8606faf5))
  *  enhance authentication handling by adding user data checks and improving storage cleanup ([ba9ad57e](https://github.com/firstlovecenter/fl-admin-portal/commit/ba9ad57eadd730a7dc6c6e8dbe0a04fa4d522d16))
  *  add signup, reset password, and setup password pages; enhance forgot password and login pages with form validation and password strength indicator ([9c8a96c6](https://github.com/firstlovecenter/fl-admin-portal/commit/9c8a96c60dece9240b895e7e543d67c9d7adfd39))
* **shepherding-control:**  build projection deck for SYN-86 ([0406ef90](https://github.com/firstlovecenter/fl-admin-portal/commit/0406ef905ef1e99e483ffee54bebf8c46a3fbede))
* **maps:**  rebuild as shadcn workspace, add to sidebar ([52367f4e](https://github.com/firstlovecenter/fl-admin-portal/commit/52367f4eeadc63a2297ed2513612a60c25d13018))
* **api:**  close IDOR write gap with assertChurchScope on 13 mutations ([e642ed90](https://github.com/firstlovecenter/fl-admin-portal/commit/e642ed906715f8572613e7d162751180cca20275))
* **schema:**
  *  paginate defaulter list fields ([47066bc9](https://github.com/firstlovecenter/fl-admin-portal/commit/47066bc9b3f4a4987ee2f3f82d81c777daabc119))
  *  paginate directory search fields ([df5298c1](https://github.com/firstlovecenter/fl-admin-portal/commit/df5298c1b9f855c213f7bc7d8cb31945b9563459))
  *  paginate history fields with offset and historyCount sibling ([d54ae6fc](https://github.com/firstlovecenter/fl-admin-portal/commit/d54ae6fc24bfe75fb0f0249f5bdebdbb1c28882e))
* **components:**  refactor ErrorScreen and LoadingScreen for improved UI and error handling feat(services): enhance DownloadMembershipList with better data formatting and CSV export functionality chore(graphql): update query return values for clarity in Oversight and Bacenta types ([0bb0333d](https://github.com/firstlovecenter/fl-admin-portal/commit/0bb0333d1d50513adb2a51f684526903cda78e45))
* **tooling:**  add e2e-tester agent with role-aware Chrome DevTools testing ([9d81f058](https://github.com/firstlovecenter/fl-admin-portal/commit/9d81f058b7594a695f12b3833528931744f97522))
* **navigation:**  enhance MobileNavItem to support active state styling and update secondaryNav documentation ([12b1a659](https://github.com/firstlovecenter/fl-admin-portal/commit/12b1a6596620c1d7287ea9b5305438303d0c6f59))
* **auth,dashboards:**  redesign login flow and user dashboard ([781b7e5f](https://github.com/firstlovecenter/fl-admin-portal/commit/781b7e5f8d7f33929f5ff943fad490ad871e0a95))
* **TrendSpark:**  enhance data handling and visualization with improved chart interactivity and state management feat(UserDashboard): update service data handling and improve navigation for current week services fix(userChurchDataQueries): increase service and aggregate record limits for better data retrieval refactor(graphs-utils): optimize data sorting and average calculation for service statistics ([c2e01a20](https://github.com/firstlovecenter/fl-admin-portal/commit/c2e01a20b41d14bb9b3f8526eed39d8e33c8ce6b))
* **UserDashboard:**  add ChurchRoleScopePicker and enhance role context display ([bd492370](https://github.com/firstlovecenter/fl-admin-portal/commit/bd492370d68829e50af521347a2ac4a5d74426d5))
* **MemberDisplay:**  remove CreateMemberAccount mutation and associated button ([976dbe18](https://github.com/firstlovecenter/fl-admin-portal/commit/976dbe187f30fc7208f6ec3e06710d27f61da602))
* **SetupPasswordPage:**  extract email from token and remove email field from form ([aa767aee](https://github.com/firstlovecenter/fl-admin-portal/commit/aa767aeef03aa95c20d631035c00d6f311445c03))
* **SetPermissions:**
  *  allow public routes to render without authentication checks ([00a05315](https://github.com/firstlovecenter/fl-admin-portal/commit/00a053157bc41e35299904e118df982349496a7b))
  *  implement public route handling to skip auth checks ([3a163228](https://github.com/firstlovecenter/fl-admin-portal/commit/3a163228d3f73971ca2ca22e7a53c5d285d45995))
* **amplify:**
  *  update production environment label to use rocket emoji ([6a5c919c](https://github.com/firstlovecenter/fl-admin-portal/commit/6a5c919c6a6b5dd9ccdd7bbe878292de3107e6f0))
  *  enhance secret export process to handle invalid keys and preserve formatting ([2f3bb937](https://github.com/firstlovecenter/fl-admin-portal/commit/2f3bb9373db0cbe2d414234a5c7d9a4ba1666e20))
  *  improve jq installation check and enhance Slack webhook error messaging ([6de70589](https://github.com/firstlovecenter/fl-admin-portal/commit/6de70589fb60cf0f6b9f43665f4cea3cbb037ebf))
  *  enhance Slack notifications with detailed build status and duration tracking ([b23a545a](https://github.com/firstlovecenter/fl-admin-portal/commit/b23a545a4141f7a7669d7aedf113bd16aaf8aeba))
  *  enhance preBuild and build phases with Slack notifications and improved secret handling ([3b804003](https://github.com/firstlovecenter/fl-admin-portal/commit/3b804003989c0b86e6cb148325d870b632878f09))
* **slack:**
  *  improve Slack message formatting and sanitize commit details ([0a54ea04](https://github.com/firstlovecenter/fl-admin-portal/commit/0a54ea04ae035fbfed7794a4af69c78e4d41529e))
  *  enhance Slack notification logging for better debugging ([7b7f5952](https://github.com/firstlovecenter/fl-admin-portal/commit/7b7f595253ff425c40bda7342ffbeb242bef437d))
* **notification:**
  *  enhance HTML email template for Outside Accra Weekly Report with detailed insights and improved formatting ([114a6cc8](https://github.com/firstlovecenter/fl-admin-portal/commit/114a6cc87d020ef2cedd63ce5281e8de1aa1eee2))
  *  enhance error handling and logging for Google Sheets and notification sending ([9e250ed7](https://github.com/firstlovecenter/fl-admin-portal/commit/9e250ed74d0a6f6aec14b59e6fbb676b421a3cd7))
  *  update recipient list for Outside Accra Weekly Report ([475717c9](https://github.com/firstlovecenter/fl-admin-portal/commit/475717c9d3933ec15da39f41ab72c1a31ada4060))
* **generateCSV:**  enhance CSV generation by merging data arrays and improving header handling ([1874b427](https://github.com/firstlovecenter/fl-admin-portal/commit/1874b427d5e45c26d09c41315ca7bbdec6dd8b6f))
* **graphql:**
  *  enhance schema generation and request handling with detailed logging ([d2b691d5](https://github.com/firstlovecenter/fl-admin-portal/commit/d2b691d5f540e652ffbdda9ef91f7413e87b9ba6))
  *  add lambda entry point to re-export graphql handler ([a5c1f88b](https://github.com/firstlovecenter/fl-admin-portal/commit/a5c1f88b09a3dcffc5ceb670fa3acac2daf5cea9))
* **member:**  add Cypher query to count distinct members in memberCount field ([c428e156](https://github.com/firstlovecenter/fl-admin-portal/commit/c428e15658d8e618ea64a182dc4310f998903f0c))

##### Bug Fixes

* **directory:**
  *  refresh parent detail list after creating a child church (SYN-161) ([b275febb](https://github.com/firstlovecenter/fl-admin-portal/commit/b275febb32b131a6756476d0dda2601dad48e17b))
  *  make stream admins double as stream tellers ([74e9f50d](https://github.com/firstlovecenter/fl-admin-portal/commit/74e9f50df3cb4de143ecc7cd16f8b7ad37e68916))
  *  gate add-child button by current-level admin ([c1b8bad6](https://github.com/firstlovecenter/fl-admin-portal/commit/c1b8bad60f409c7ed60cadf9087fe1cfe9c86b8c))
  *  make denomination leader changes work end-to-end ([9e0a2b66](https://github.com/firstlovecenter/fl-admin-portal/commit/9e0a2b66a43f5ae9955ff29db0e901f821af51cd))
  *  make makeServantCypher writes atomic ([d3789c3e](https://github.com/firstlovecenter/fl-admin-portal/commit/d3789c3e83a47fc63f06312bffea2ab55b329f52))
  *  bound Governorship.pastorCount HAS traversal ([eb395d24](https://github.com/firstlovecenter/fl-admin-portal/commit/eb395d242a51000d3ebcbaee50bbc6ba23b6b644))
  *  gate spine pastorCount + harden basonta writes ([ac8b72e3](https://github.com/firstlovecenter/fl-admin-portal/commit/ac8b72e383cf2e38c94db9c233c6b385b662dc96))
  *  gate every spine members field + close download IDOR ([1be10e01](https://github.com/firstlovecenter/fl-admin-portal/commit/1be10e015fd02b3bfa80d1448122eca097f77e92))
  *  remove excess left padding in church detail header on mobile ([8a5d63c9](https://github.com/firstlovecenter/fl-admin-portal/commit/8a5d63c9da746a002dc77ef84b668db5a2b84839))
  *  reserve header padding for floating nav buttons on mobile ([dce74925](https://github.com/firstlovecenter/fl-admin-portal/commit/dce74925d62363d34e1d0ecd1c7778576844fc84))
  *  remove defunct target field crashing Governorship page ([8c46ef7e](https://github.com/firstlovecenter/fl-admin-portal/commit/8c46ef7e790a457bf3cef93aa7f9c2839ad137ae))
  *  gate stream-bacentas back button to pwa standalone ([b528bad4](https://github.com/firstlovecenter/fl-admin-portal/commit/b528bad44c07b99178a067ecb6abdb29f818c204))
  *  unblock sticky note save and tidy delete button ([b6be4b54](https://github.com/firstlovecenter/fl-admin-portal/commit/b6be4b54788a171525cf43f0cdf2a954823ff4cd))
  *  cap sub-church preview at 3 and flush +more button height ([e7d67ed3](https://github.com/firstlovecenter/fl-admin-portal/commit/e7d67ed3042e4bc6d37e939bef531e5b71da78b2))
  *  repair leader avatars and church preview overflow hint ([988aaa2a](https://github.com/firstlovecenter/fl-admin-portal/commit/988aaa2aaa7620e60b593c2b715a24408ad107ed))
  *  center submit button on bacenta edit form ([f72956fa](https://github.com/firstlovecenter/fl-admin-portal/commit/f72956fa569916749e27c513b9ea8c97ae0d1278))
  *  guard against missing meetingDay in update form ([51f3adf0](https://github.com/firstlovecenter/fl-admin-portal/commit/51f3adf010c36178697831ceecee6fffdeeffd82))
  *  update MemberForm header to match app standard ([df00f269](https://github.com/firstlovecenter/fl-admin-portal/commit/df00f269a3b7eeaaef9dae62390ade49563e3d8e))
  *  mirror member card shape in desktop loading skeleton ([96878298](https://github.com/firstlovecenter/fl-admin-portal/commit/96878298edd0cd4a21d0f538efa4a990877a34d5))
  *  point Service Forms button to /services ([9f626d22](https://github.com/firstlovecenter/fl-admin-portal/commit/9f626d226866f04db5a7dd802fac844ee070efaa))
  *  hide empty leadership roles and church history sections ([fd72a4aa](https://github.com/firstlovecenter/fl-admin-portal/commit/fd72a4aad28c3f0552da0e45b587fcc521cdda1f))
  *  pass empty values to resetForm so filter reset clears checkboxes ([effcd829](https://github.com/firstlovecenter/fl-admin-portal/commit/effcd82957f17fe0cae424619b1079718e91bbde))
  *  address code review findings from directory redesign ([cd6a8653](https://github.com/firstlovecenter/fl-admin-portal/commit/cd6a86538684ce5c9712ed2c75b1df662f51322e))
* **lambda:**
  *  populate fellowship attendance in outside accra report ([6ac0f2be](https://github.com/firstlovecenter/fl-admin-portal/commit/6ac0f2be9217946d2f208b65a9a0e07b43682590))
  *  rethrow aggregator errors, fix bussing date var shadowing ([aafbcfe5](https://github.com/firstlovecenter/fl-admin-portal/commit/aafbcfe5879e4a6750392f1c44709823a6693817))
  *  verify Paystack HMAC and guard webhook state writes ([2d2f1928](https://github.com/firstlovecenter/fl-admin-portal/commit/2d2f1928a74d65f0c039886f973935a9c690e251))
  *  register defaulters and arrivals download routes ([6cab000d](https://github.com/firstlovecenter/fl-admin-portal/commit/6cab000d947df470d393188bdf3c4b2f3a3c3f34))
* **services:**
  *  stop trends selector pills overflowing the chart title ([1045ac90](https://github.com/firstlovecenter/fl-admin-portal/commit/1045ac90d31bdcea844fbc0d06d02b7d06d1dfac))
  *  stop getMondayThisWeek mutating its Date argument ([375dd502](https://github.com/firstlovecenter/fl-admin-portal/commit/375dd502d0c3ab5f855e18dfd00efc4e2fae392e))
  *  restrict service form date to current week only ([79c2900b](https://github.com/firstlovecenter/fl-admin-portal/commit/79c2900bc82586f44f1e831c3cca93e6112f479e))
  *  MERGE idempotency and income guard for RecordService ([faf13be8](https://github.com/firstlovecenter/fl-admin-portal/commit/faf13be8b8dfb0ed05f20eb2aecc4af573747b41))
  *  hide banking and admin items when viewing a foreign church ([e0a13ca5](https://github.com/firstlovecenter/fl-admin-portal/commit/e0a13ca5253745c59cd01739cea886d71a897ad2))
  *  pass viewed church via nav state to Trends and Services menus ([9fafc62b](https://github.com/firstlovecenter/fl-admin-portal/commit/9fafc62b7ebc783581768cf115a63d7d6b635ba3))
  *  prevent income inflation from stale CURRENT_HISTORY edges ([168e2909](https://github.com/firstlovecenter/fl-admin-portal/commit/168e2909c1ece2668c4214fe24fb0a2766f49e3b))
  *  unblock defaulters download — CORS, Radix ref, SDL args ([987b1e83](https://github.com/firstlovecenter/fl-admin-portal/commit/987b1e8337e53e7156b206a9a118dbdbcd9fbf4e))
  *  use placeholder skeletons on defaulters dashboard ([d5d29e67](https://github.com/firstlovecenter/fl-admin-portal/commit/d5d29e67d1ce090f97bf88252972602bf877adce))
  *  remove dropped income prop from ChurchGraph call sites ([96efeff1](https://github.com/firstlovecenter/fl-admin-portal/commit/96efeff110f3a9b5b876c4f7b23841fb48885690))
  *  apply noIncomeTracking gate consistently on service details ([bd4be844](https://github.com/firstlovecenter/fl-admin-portal/commit/bd4be844ed71cdbb79147d32227ffbbddecf3312))
  *  de-duplicate weekly aggregate graphs across leader changes ([73c6db8a](https://github.com/firstlovecenter/fl-admin-portal/commit/73c6db8a6c6f25bf41f5fae3f537d2c1299f018b))
* **arrivals:**
  *  stop vehicle pictures swapping between records ([7a7ee29f](https://github.com/firstlovecenter/fl-admin-portal/commit/7a7ee29fee7084d05a9363ce39fef3dace2b87ee))
  *  allow unlimited vehicle uploads per bussing day ([1587cb3d](https://github.com/firstlovecenter/fl-admin-portal/commit/1587cb3ddc1c4c53a7715ebb825c48d7a5b6e31f))
  *  default to today, not last Sunday, with no date param ([761020e2](https://github.com/firstlovecenter/fl-admin-portal/commit/761020e220ffd13faa35f930c0ca44b3f49342dd))
  *  land on most recent Sunday when no date param ([6961ea30](https://github.com/firstlovecenter/fl-admin-portal/commit/6961ea30a3de025093112575e31b9ce861e6988f))
  *  council payer focus + today-only counting and paying ([6d972eb1](https://github.com/firstlovecenter/fl-admin-portal/commit/6d972eb13c1316f268224f66332dcbe2de606a1a))
  *  use Mon→Sun church week in date selector ([913ed815](https://github.com/firstlovecenter/fl-admin-portal/commit/913ed815ed06401c9ffd73ffd3160ce3dc548687))
  *  restore CouncilByGovernorship + drop stray BacentaWithArrivals override ([3052f221](https://github.com/firstlovecenter/fl-admin-portal/commit/3052f221ef62803c71fa01a0a31156ca945cb29f))
  *  validate attendance and vehicle in ConfirmVehicleByAdmin ([7c5cb033](https://github.com/firstlovecenter/fl-admin-portal/commit/7c5cb033576adb966aac4e31f5843478a24f2023))
  *  make ConfirmVehicleByAdmin once-only ([f98c8e2a](https://github.com/firstlovecenter/fl-admin-portal/commit/f98c8e2ae1eee648a90a81cb79061f83867009a6))
  *  scope ConfirmVehicleByAdmin via vehicle record ([358edac5](https://github.com/firstlovecenter/fl-admin-portal/commit/358edac554e33e49cc4b0399bf354e714eb8c849))
  *  idempotent vehicle record on re-submit; fix catch error ([f5f0a6e6](https://github.com/firstlovecenter/fl-admin-portal/commit/f5f0a6e655856b41741374e552d6356b15820651))
  *  stop stream dashboard settings clashing with shell toggle ([6f396bc1](https://github.com/firstlovecenter/fl-admin-portal/commit/6f396bc1974e8da651d3288923aa25a19c50d422))
  *  unbreak payment data query under neo4j 5 ([0909e226](https://github.com/firstlovecenter/fl-admin-portal/commit/0909e2265b07c1b8ac15a829b39e27cda45e5b83))
  *  keep page chrome on date change via previousData ([6927f09c](https://github.com/firstlovecenter/fl-admin-portal/commit/6927f09c3728581fc0480a833fb671e6bb8f1bd9))
  *  keep expanded governorship card in view on tap ([0fef1be2](https://github.com/firstlovecenter/fl-admin-portal/commit/0fef1be28ca00158096a190731035bb11522c6eb))
  *  pair download button with Bacenta Status title ([5b016246](https://github.com/firstlovecenter/fl-admin-portal/commit/5b016246e52fd46a842d6d5625f8f722ae02bd44))
  *  move ArrivalsHeader into right aside on Campus and Governorship ([a9736d90](https://github.com/firstlovecenter/fl-admin-portal/commit/a9736d907e21fa4f76cb0927e3a239a4cbec1f3c))
  *  move ArrivalsHeader into right aside on desktop ([adb324b5](https://github.com/firstlovecenter/fl-admin-portal/commit/adb324b5ef0248aaf3fee2a264f97c4be8e8b789))
  *  use semantic button element in BacentaArrivalsCard ([53e62d12](https://github.com/firstlovecenter/fl-admin-portal/commit/53e62d12b16edafabf25532536fb702284fb2adb))
  *  unblock adding more vehicles after bussing form submit ([768bd1c9](https://github.com/firstlovecenter/fl-admin-portal/commit/768bd1c96f911b5d6609b30e397172ccaaf02fe8))
  *  fix vehicle record form crash and stale bussing query fields ([78ee1aa6](https://github.com/firstlovecenter/fl-admin-portal/commit/78ee1aa64bfa82588e02e7f2b9abcdaa23def8a7))
  *  pass bussingDate variable to BACENTA_ARRIVALS in FormAddVehicleRecord ([03e6f963](https://github.com/firstlovecenter/fl-admin-portal/commit/03e6f963f3d0f7dafa960a71d79e5246e0ce605b))
* **web:**
  *  force-revalidate PWA entry point so amplify redeploys apply ([55e3b05f](https://github.com/firstlovecenter/fl-admin-portal/commit/55e3b05fbd21d45a072a0d8e220abdf5cd70d624))
  *  show success toasts in green instead of red ([464fbe57](https://github.com/firstlovecenter/fl-admin-portal/commit/464fbe57eaee5d3d2db039901045e3dbabe1bc36))
  *  stop PWA back button clipping mobile page titles ([f66860f3](https://github.com/firstlovecenter/fl-admin-portal/commit/f66860f3cf244420b9038e482a414aae4276a4ed))
  *  scope retry to 5xx, surface link errors once per query ([e0b55967](https://github.com/firstlovecenter/fl-admin-portal/commit/e0b559676dac1fb51349786e1a2a9f2d72a41351))
  *  cast permittedRoles element to Role to satisfy strict includes check ([8508eea7](https://github.com/firstlovecenter/fl-admin-portal/commit/8508eea79de55138e220c550e87f233905a9b1be))
  *  clear member search error on first select ([03622b58](https://github.com/firstlovecenter/fl-admin-portal/commit/03622b581ba10bdac71ec6fc8d33173f111450ed))
  *  bound apollo error dialog and add copy button ([bfc9f45d](https://github.com/firstlovecenter/fl-admin-portal/commit/bfc9f45d22fce154d232717d2748b9fdc2bd4940))
  *  constrain submit button width on desktop ([83812974](https://github.com/firstlovecenter/fl-admin-portal/commit/838129744b15ee550604351badebbd93ff69b366))
  *  migrate Apollo queries to @neo4j/graphql v7 input shapes ([c9e65f21](https://github.com/firstlovecenter/fl-admin-portal/commit/c9e65f21800baf34a785c4dfaca6dd7c26b22651))
  *  add error/loading lifecycle to hook refetch wrappers ([acb9674d](https://github.com/firstlovecenter/fl-admin-portal/commit/acb9674dc1faaad25407c09c7ce75ee62fa567ce))
  *  pull-to-refresh now updates legacy level hook state ([e35f940a](https://github.com/firstlovecenter/fl-admin-portal/commit/e35f940a0ec87f5b2e97032344d83899871d5e50))
  *  apply code-review fixes to history pagination ([ed14b909](https://github.com/firstlovecenter/fl-admin-portal/commit/ed14b909977a804c918271dbd34c3df9286f3815))
* **cypher:**
  *  drop pre-creation aggregates and log church moves ([ecc515e0](https://github.com/firstlovecenter/fl-admin-portal/commit/ecc515e083be349d2fcfef611b0e20edf10c1aeb))
  *  return campus financial fields from createCampus ([58cc2a3d](https://github.com/firstlovecenter/fl-admin-portal/commit/58cc2a3d1aceaeb1f6226c5a152305ce4fb7544a))
  *  drop pre-creation aggregates and log church moves ([d0e821b1](https://github.com/firstlovecenter/fl-admin-portal/commit/d0e821b12b92c0d3c05a3dbb050ce27a5c3b5f8c))
  *  return campus financial fields from createCampus ([d13944d6](https://github.com/firstlovecenter/fl-admin-portal/commit/d13944d6df52c265e89123a7a2d119b8e465c25c))
  *  return campus financial fields from createCampus ([918729d6](https://github.com/firstlovecenter/fl-admin-portal/commit/918729d6bc65a634eae005e74c0fea66208e3e56))
  *  break aggregate dedup ties by attendance and canonical id ([6703c9cf](https://github.com/firstlovecenter/fl-admin-portal/commit/6703c9cf17e3314dadf3d75f19e1fcd6608b5d90))
  *  correct ServiceLog label typo in church data query ([0fcef0e5](https://github.com/firstlovecenter/fl-admin-portal/commit/0fcef0e5a1169c4abbe64d2cdf1fe10df6322990))
  *  match Governorship not Constituency in church query ([caa22ddd](https://github.com/firstlovecenter/fl-admin-portal/commit/caa22ddd40d77bcd99203cbfe68fcd69af35d801))
  *  dedupe records before per-week sum on governorship reads ([4211fb55](https://github.com/firstlovecenter/fl-admin-portal/commit/4211fb5590c388167da2800344022e059e959578))
  *  dedupe records before per-week sum on bacenta reads ([fa0fab7a](https://github.com/firstlovecenter/fl-admin-portal/commit/fa0fab7a21c7d6cd12f31bff1f2230f2bfff4dab))
* **deps:**
  *  update caniuse-lite to version 1.0.30001793 with new integrity hash ([3a9039cc](https://github.com/firstlovecenter/fl-admin-portal/commit/3a9039cc0d58cd5bb4eb6f85e832a6758a23668e))
  *  update caniuse-lite to version 1.0.30001793 with new integrity hash ([0c37160d](https://github.com/firstlovecenter/fl-admin-portal/commit/0c37160d4f945a0eb72d356ee098b697b352505a))
* **api:**
  *  stop coercing rejected jwt to {} so @authentication works ([9aedbafd](https://github.com/firstlovecenter/fl-admin-portal/commit/9aedbafdba13ebe8bf3ffb355e7abd6dddcd61c9))
  *  block unauthenticated mutations and disable autogen CRUD ([19fd058d](https://github.com/firstlovecenter/fl-admin-portal/commit/19fd058d0df8b2017926a1daa9ff3c4150064052))
  *  stop coercing rejected jwt to {} so @authentication works ([d0a0570f](https://github.com/firstlovecenter/fl-admin-portal/commit/d0a0570f42a92eddb534b98fa430d1ed558468e2))
  *  block unauthenticated mutations and disable autogen CRUD ([11e70553](https://github.com/firstlovecenter/fl-admin-portal/commit/11e70553f5a4e9f3728b97540559109ceeb777cd))
  *  relocate llm-client into resolvers so graphql lambda loads ([3b1b73f1](https://github.com/firstlovecenter/fl-admin-portal/commit/3b1b73f1a408fa23abb75dba8787ab7d5a456d2d))
  *  batched utils + cypher hardening (SYN-100, SYN-103, SYN-104) ([12c9dbe4](https://github.com/firstlovecenter/fl-admin-portal/commit/12c9dbe4a63d5c83b8242a6972ffebef7ca03972))
  *  gate SetVehicleSupport and SendVehicleSupport on vehicle scope ([a0407e33](https://github.com/firstlovecenter/fl-admin-portal/commit/a0407e33b46ab813d3078c257b30b04a17db5d81))
  *  scope-check ApproveExpense by transaction's owning council ([82d0aeb0](https://github.com/firstlovecenter/fl-admin-portal/commit/82d0aeb0984f8a0bc50d228fcf185ae4bca7519a))
  *  restore auth on DepositIntoCouncilBussingSociety ([86807e50](https://github.com/firstlovecenter/fl-admin-portal/commit/86807e5008017f2620387093e9bc2b8dff77619c))
* **graphs:**
  *  derive year from service date for accurate sorting and labeling ([06e129fc](https://github.com/firstlovecenter/fl-admin-portal/commit/06e129fc0faba9403325c9f65bea2c95746ccd5d))
  *  derive year from service date for accurate sorting and labeling ([2168773e](https://github.com/firstlovecenter/fl-admin-portal/commit/2168773eaab7559e67b6ab87310a77b89500562e))
  *  show year alongside week in chart tooltip ([bf706c7c](https://github.com/firstlovecenter/fl-admin-portal/commit/bf706c7cc0f68363c49173e66de2a47791947d73))
  *  display year in week labels to prevent confusion ([22ee9ff1](https://github.com/firstlovecenter/fl-admin-portal/commit/22ee9ff1052ae8902e65adba76a6c19b28eae35b))
  *  correct week sorting to prevent mixed years in church graphs ([217eea09](https://github.com/firstlovecenter/fl-admin-portal/commit/217eea0938014327bfd2231b0e5d85aa0f3bb773))
* **back-button:**  prevent navigation from home page with no meaningful back action ([5ea58767](https://github.com/firstlovecenter/fl-admin-portal/commit/5ea5876739e273921f7e183420b3b5fb38983272))
* **date-utils:**  preserve `parseTimeToDate` byte-equivalence (SYN-61 review fix) ([1eecef58](https://github.com/firstlovecenter/fl-admin-portal/commit/1eecef586d47fb893583dab7717eacd633892a12))
* **ci:**  integration workflow tests the PR head, not the base (SYN-83) ([cd6dc00e](https://github.com/firstlovecenter/fl-admin-portal/commit/cd6dc00efe6cc8e589879e313d1395feb271f074))
* **banking:**
  *  readable audit message + skeleton loaders + round avatar ([98a19f5d](https://github.com/firstlovecenter/fl-admin-portal/commit/98a19f5d584a15b31935c703d4bdf52c3e2441c9))
  *  sanitize Paystack/Neo4j error leakage to leaders' UI ([3b7fc227](https://github.com/firstlovecenter/fl-admin-portal/commit/3b7fc22743300f806f2f60fb75c4f8f7fe697e50))
  *  close edge-case gaps in self-banking flow ([e49c036e](https://github.com/firstlovecenter/fl-admin-portal/commit/e49c036e881b5f878025509e34ec5f7ee5c14a81))
  *  guard resolver-side SM1 transitions against webhook races ([a104cdd4](https://github.com/firstlovecenter/fl-admin-portal/commit/a104cdd432074e09e9827af530730e9555709e51))
  *  tighten PayOffering error UX and OTP dialog flow ([5443c5b7](https://github.com/firstlovecenter/fl-admin-portal/commit/5443c5b7d7895db0b9c39a8ce49cecfe13c80aa7))
  *  tighten input validation, state guards, and idempotency ([0fd37afc](https://github.com/firstlovecenter/fl-admin-portal/commit/0fd37afcd01ed28ea9c1e89977a070f56925dc04))
  *  tighten self-banking review findings ([b85085e5](https://github.com/firstlovecenter/fl-admin-portal/commit/b85085e5564c3f9dd94e8ba5b04189ac8573abe9))
* **auth:**
  *  close URL-bypass into per-level Members + QuickFacts + history (SYN-143) ([7ffcba75](https://github.com/firstlovecenter/fl-admin-portal/commit/7ffcba75022c6045fcec69e8654629f86576c134))
  *  close breadcrumb ancestor click + render foreign bacenta name ([029ba277](https://github.com/firstlovecenter/fl-admin-portal/commit/029ba277e273c6ca50865b35785a9efce277d2f5))
  *  flatten church-scoped auth filter to id-in-list lookup ([71685570](https://github.com/firstlovecenter/fl-admin-portal/commit/71685570a64dc6f9b55ba4c2187d1ab1d131a0db))
  *  reconcile permitAdmin Bacenta role order (ADR-001) ([013833e9](https://github.com/firstlovecenter/fl-admin-portal/commit/013833e9f3b32c0a74f4af7be21897b11ff844c9))
  *  tighten membership-write and reports tile to permitLeaderAdmin ([f26a31c5](https://github.com/firstlovecenter/fl-admin-portal/commit/f26a31c59fbfa9651e6e67e8d41130f1e1ce8f41))
  *  silent refresh and reactive gate on token expiry ([73a576bd](https://github.com/firstlovecenter/fl-admin-portal/commit/73a576bd76ff31091c239d8842ab3d3456eb4d4d))
  *  restore church-in-focus after Creative Arts cleanup ([241f5691](https://github.com/firstlovecenter/fl-admin-portal/commit/241f56915753927d65a8769c804f40bdb2f09825))
  *  harden token persistence and cross-tab sync ([66f7ab44](https://github.com/firstlovecenter/fl-admin-portal/commit/66f7ab449c399180f1cb4d529e4952e9143e41b5))
  *  simplify role extraction from JWT by removing unnecessary URL reference ([fedeb057](https://github.com/firstlovecenter/fl-admin-portal/commit/fedeb057327028e2deb012adbd55a4cd19c106ab))
* **schema:**
  *  suppress auto-gen mutations on money + audit-trail types ([3d61466a](https://github.com/firstlovecenter/fl-admin-portal/commit/3d61466a49d51db804a9a7586ac8b9ca11327c28))
  *  correct Title uniqueness constraint to use name property ([357aa012](https://github.com/firstlovecenter/fl-admin-portal/commit/357aa012ed689f7d7e73088aedcdf9964e761108))
  *  use static $limit in Member.members LIMIT clause ([dc8e5376](https://github.com/firstlovecenter/fl-admin-portal/commit/dc8e5376ba074fa1b71ace0adf6aa50abc8e7171))
  *  migrate roles_INCLUDES to v7 includes shape ([0f69060b](https://github.com/firstlovecenter/fl-admin-portal/commit/0f69060ba54d0543f78bb713cd083c95e73d259d))
  *  bacenta-level aggregates read raw records ([1ff43219](https://github.com/firstlovecenter/fl-admin-portal/commit/1ff43219a9d1e2b7e6078f54e0186a8abea012e7))
* **downloads:**
  *  filter retired leaders from defaulters and arrivals CSVs ([2037a46a](https://github.com/firstlovecenter/fl-admin-portal/commit/2037a46afd176f48057a67c627fb6653c87c1d76))
  *  filter retired leaders from membership CSV (SYN-148) ([386c304d](https://github.com/firstlovecenter/fl-admin-portal/commit/386c304d3ae3e3f9bb785c9522a1588fcc00e681))
* **dashboards:**
  *  gate arrivals and accounts in sidebar by role ([1ca9ef33](https://github.com/firstlovecenter/fl-admin-portal/commit/1ca9ef3379f488b7cc5c7cae5b6edc09a62a3aa3))
  *  gate weekly tip query on leader/admin scope ([9bf93372](https://github.com/firstlovecenter/fl-admin-portal/commit/9bf933726936d224433f0ddaeb5954839ffa6645))
  *  restrict Accounts nav item to fishers role ([63d848fc](https://github.com/firstlovecenter/fl-admin-portal/commit/63d848fc291e8481701ca6cc5297e20587b0e80f))
  *  unblock amplify build — recharts label types and dead prop ([29bd5109](https://github.com/firstlovecenter/fl-admin-portal/commit/29bd510913a9f9b2be7b6cd54181415308b0584f))
  *  correct broken quick-action link targets ([fd04f512](https://github.com/firstlovecenter/fl-admin-portal/commit/fd04f5125cca90f2e00c6141569a58d44a20d758))
  *  use direct service/bussing records for weekly task status ([3732c54c](https://github.com/firstlovecenter/fl-admin-portal/commit/3732c54cfadf03c8b67e82066da1c23826149fc0))
* **graphql:**
  *  improve CORS handling and ensure secrets are loaded on cold start ([e7997731](https://github.com/firstlovecenter/fl-admin-portal/commit/e7997731e212710f81dd278d845382fbcc31ee64))
  *  add staging-synago origin to CORS allowed origins for development ([de66664a](https://github.com/firstlovecenter/fl-admin-portal/commit/de66664a2c084b6b4c63f59c86d6311c19728788))
  *  add synago origin to CORS allowed origins list ([da8ee43c](https://github.com/firstlovecenter/fl-admin-portal/commit/da8ee43c106955209052b0df2f9c0042d96f2c11))
  *  enhance CORS origin handling for multiple environments ([975b7d3a](https://github.com/firstlovecenter/fl-admin-portal/commit/975b7d3aaf71252df9b51ebed3729897d15ba075))
  *  clean up whitespace and correct comment typo in request parsing ([68223a35](https://github.com/firstlovecenter/fl-admin-portal/commit/68223a351b0d272d788b6571205f95f5724698db))
  *  comment out combined schema output to prevent file writing ([bb670c67](https://github.com/firstlovecenter/fl-admin-portal/commit/bb670c67a654dcb4396a5fe4abd49aa21b2e96a8))
  *  add debugging logs for SECRETS and remove Netlify configuration ([bbe890cd](https://github.com/firstlovecenter/fl-admin-portal/commit/bbe890cda8019516806aa1f57dcb2560ec9af957))
  *  add exclamation mark to connection success log message ([639edc15](https://github.com/firstlovecenter/fl-admin-portal/commit/639edc15a411c835159a147a3465ac9dc0bb3c08))
  *  update CORS origin handling to use 'development' instead of 'dev' ([1ab87e84](https://github.com/firstlovecenter/fl-admin-portal/commit/1ab87e84e932871149ec4a01de0e91eba313063c))
  *  ensure SECRETS are loaded correctly and update CORS origin handling ([31cc36ee](https://github.com/firstlovecenter/fl-admin-portal/commit/31cc36eeb009a7b78a1d79f9d3aaf80ac5e9b834))
* **accounts:**
  *  close ApproveExpense TOCTOU; solvency in WHERE (SYN-120) ([e78c0b5d](https://github.com/firstlovecenter/fl-admin-portal/commit/e78c0b5d9f81c85263f117b26c672922ef5f24cb))
  *  repoint Approvals query and redesign in Shadcn ([02c48a72](https://github.com/firstlovecenter/fl-admin-portal/commit/02c48a7277c58745cda9641bac6d3a7a0460ced0))
  *  server-side accounts office-hours gate (SYN-111) ([cf7a1f88](https://github.com/firstlovecenter/fl-admin-portal/commit/cf7a1f889910931c7e5ae4ca1d0ca6beb8beb004))
  *  detach SMS dispatch from ApproveExpense critical path (SYN-102) ([b64c64f6](https://github.com/firstlovecenter/fl-admin-portal/commit/b64c64f685510c17d66f61b9e51616b8ad56562c))
  *  validate money args on every accounts mutation (SYN-93) ([bb1d09c9](https://github.com/firstlovecenter/fl-admin-portal/commit/bb1d09c9e2654b68ce1dd324e776e0230260225b))
  *  atomic ApproveExpense bussing branch (SYN-94) ([489ca2ff](https://github.com/firstlovecenter/fl-admin-portal/commit/489ca2ffef29132293fc76b01a14abd641a92b8f))
  *  status precondition on approve mutations (SYN-92) ([f322e88e](https://github.com/firstlovecenter/fl-admin-portal/commit/f322e88e364152dd5477658366e6fcfb10f90c9a))
  *  tighten role gates to 3 church roles AND fishers (SYN-98) ([b72edc0b](https://github.com/firstlovecenter/fl-admin-portal/commit/b72edc0bcd996b39a42f4ce6fa5a426a883fcfe3))
  *  pass transactionDescription from resolver, not Cypher float-concat (SYN-112 cherry-pick) ([bd3925bf](https://github.com/firstlovecenter/fl-admin-portal/commit/bd3925bf6afbfa5bc07d3bd351a742915eafde82))
  *  cap transactions(limit) and index lastModified (SYN-105) ([b51f476b](https://github.com/firstlovecenter/fl-admin-portal/commit/b51f476b9df8af795912b18309c2dc0abe40d521))
  *  refetchQueries on every balance-changing mutation (SYN-109) ([f598b829](https://github.com/firstlovecenter/fl-admin-portal/commit/f598b8293817513563df736392f332bf6548b326))
  *  per-card lock + missing fragment key in Approvals (SYN-110) ([a5e14252](https://github.com/firstlovecenter/fl-admin-portal/commit/a5e142529f8843deb02401ec7e62ee64b9cdfced))
  *  bussingAmount aggregates from ledger, not stale scalar (SYN-99) ([e26139e0](https://github.com/firstlovecenter/fl-admin-portal/commit/e26139e01b0506208cb9808637fdb410423d497b))
  *  IDOR — scope transaction reads with @churchScoped/@churchScopedVia (SYN-95) ([5c88f418](https://github.com/firstlovecenter/fl-admin-portal/commit/5c88f418ff0396a0e301f3bf0be7869da1542909))
  *  clientTransactionId MERGE idempotency end-to-end (SYN-97) ([60eb2e8a](https://github.com/firstlovecenter/fl-admin-portal/commit/60eb2e8aa1381b5d6615b2c05eb9e2b50e2f32ae))
* **scripts:**  epub chapter flow + non-routing neo4j uri for ingestion ([c8943cb4](https://github.com/firstlovecenter/fl-admin-portal/commit/c8943cb432275e6bbff7edf6cad0fc34aae81882))
* **shepherding-control:**  polish PDF + slide UX from review ([e4a57bab](https://github.com/firstlovecenter/fl-admin-portal/commit/e4a57bab4ddc553c48f0133cea30f950e55a5f16))
* **amplify:**
  *  clarify secret name selection for branches ([386b263f](https://github.com/firstlovecenter/fl-admin-portal/commit/386b263f566d987b15907953ac3e4ec0c8c25aff))
  *  update environment labels and secret handling for staging branch ([462fc6ed](https://github.com/firstlovecenter/fl-admin-portal/commit/462fc6ed61e0203b879ffa7e3f6bc4ed20af1d31))
  *  remove unnecessary Slack notifications for preBuild and build phases ([5995a52d](https://github.com/firstlovecenter/fl-admin-portal/commit/5995a52ded6a34be63105f8e2176ed7c5acc336b))
  *  correct pipefail option in preBuild and build commands ([cc0f3570](https://github.com/firstlovecenter/fl-admin-portal/commit/cc0f35704014cd29ba47d3344bb1849e5b6d9fef))
  *  update jq installation command to use yum only ([47acac8e](https://github.com/firstlovecenter/fl-admin-portal/commit/47acac8e5c63722b6997886ab3b4c3ed32c04dd3))
* **reports:**  bacenta weekly report reads raw records, no null id ([a066ace9](https://github.com/firstlovecenter/fl-admin-portal/commit/a066ace94fc087f51f3aec1c2677d850e052da44))
* **TrendSpark:**  adjust bar chart margin and format week labels in X-axis ticks ([338d1b7e](https://github.com/firstlovecenter/fl-admin-portal/commit/338d1b7efbaea7177a158153436e3377e6b632c3))
* **index:**  remove debug log for JWT in startServer function ([01c8ef0f](https://github.com/firstlovecenter/fl-admin-portal/commit/01c8ef0fddc5342407710a02693364f036b9297a))
* **deploy:**  exclude test files from TypeScript compilation in deployment workflow ([40e1f07b](https://github.com/firstlovecenter/fl-admin-portal/commit/40e1f07b640873e2df3a1791dc896ecb5b83435a))
* **tsconfig:**  ensure test files are excluded from compilation ([1a73ddee](https://github.com/firstlovecenter/fl-admin-portal/commit/1a73ddeead01f4a372f796246de34b87dd8d915f))
*  revert SYN-53 — remove Bacenta UNION from Governorship aggregate fields, restore ORDER BY/SKIP/LIMIT ([08d0a75f](https://github.com/firstlovecenter/fl-admin-portal/commit/08d0a75f8a35c8a143d61b8c1f4414479c7e8c00))
*  revert SYN-53 — remove Bacenta UNION from Governorship aggregate fields, restore ORDER BY/SKIP/LIMIT ([5ed78cf6](https://github.com/firstlovecenter/fl-admin-portal/commit/5ed78cf64311b1f3a6a745f093cb1cb282251401))
*  Correctly include Campus resolver in the resolvers object ([0fce17fe](https://github.com/firstlovecenter/fl-admin-portal/commit/0fce17fefd62e08793473f234755bccd00235732))
*  Update email recipient for Outside Accra Weekly report ([d073f07e](https://github.com/firstlovecenter/fl-admin-portal/commit/d073f07e958916932df8cfec63e6a02806549b6d))
*  update formatting in Amplify deployment guide for clarity and consistency ([c2c8c470](https://github.com/firstlovecenter/fl-admin-portal/commit/c2c8c47090eaebb539240d1b47501ad70ed8db26))
*  remove Auth0 dependencies and fix TypeScript compilation errors ([ec5afdd3](https://github.com/firstlovecenter/fl-admin-portal/commit/ec5afdd3b6b8330c56e44eef26fca80bacb3432d))
*  correct formatting of Neo4j driver options in server initialization ([3974d6a1](https://github.com/firstlovecenter/fl-admin-portal/commit/3974d6a12cb6e216a3e03e813c9c534ec181332a))
*  update login prompt text to specify admin portal ([c77c6401](https://github.com/firstlovecenter/fl-admin-portal/commit/c77c64013e6e62a42cd0094ec1905ff100a0f8c2))
*  update file size limit from 400 to 500 lines in Copilot instructions ([e0560fca](https://github.com/firstlovecenter/fl-admin-portal/commit/e0560fca2ff773beaf26afff066664ed7cb4cba8))
*  update test phone number in sendBulkSMS function ([4eecd950](https://github.com/firstlovecenter/fl-admin-portal/commit/4eecd9507fffd3dcc7899dfd63e285f05b4eff28))
*  update test phone number in sendBulkSMS function ([77603560](https://github.com/firstlovecenter/fl-admin-portal/commit/77603560485cd1d9eef655a41c7c45c2d22b5b37))
*  remove JD's phone number from recipient lists in multiple notification functions ([e22db1b6](https://github.com/firstlovecenter/fl-admin-portal/commit/e22db1b6f500e7a5150cf4ba5e28908689ad8ce4))
*  update Cypher queries to use optional matches for council relationships and remove mcp.json ([daa6b223](https://github.com/firstlovecenter/fl-admin-portal/commit/daa6b223fa94b0e4e58263789643b1a30451c8e2))
*  update writeToGsheet column ranges for fellowship and weekday income data ([748ba8d6](https://github.com/firstlovecenter/fl-admin-portal/commit/748ba8d652cf74022694559985aeaa39f94a9c70))
*  sanitize file name in S3 upload to remove spaces ([ec8813d1](https://github.com/firstlovecenter/fl-admin-portal/commit/ec8813d19e623f02c8f2e7d89749a296b3c05d72))
*  sanitize email in Auth0 user retrieval to remove whitespace ([6ec5e556](https://github.com/firstlovecenter/fl-admin-portal/commit/6ec5e5560c3008a5229fc4902f4116d05a06fbef))
*  comment out unused MenuButton for joint service form in StreamJoint component ([29a3c40e](https://github.com/firstlovecenter/fl-admin-portal/commit/29a3c40e1f65d4681c8ce8020247044c5b642f88))
*  update cypher queries to include aliasing for clarity in member and church types ([09356c77](https://github.com/firstlovecenter/fl-admin-portal/commit/09356c774bf5939d8514ed67478199961c5367ea))
*  update subaccount assignments for multiple bank accounts to use OA_GHSOUTH ([bdd35127](https://github.com/firstlovecenter/fl-admin-portal/commit/bdd3512795bd8505d5af0b2605fe36154d8e1673))
*  correct income rounding in total attendance income query ([007b490d](https://github.com/firstlovecenter/fl-admin-portal/commit/007b490d0d588bde52bd28e570e139ae236bba41))
*  update week number in notification message and adjust lastSunday constant assignment ([60ef4ee0](https://github.com/firstlovecenter/fl-admin-portal/commit/60ef4ee0bfdb77a63eff4d836bd52a65beac35e8))
*  update account open logic and message for clarity ([ccada2c8](https://github.com/firstlovecenter/fl-admin-portal/commit/ccada2c8cad23b8120b61b6c54622346b2675e67))
*  update income assignment to use totalDollarIncome in service aggregation queries ([44caa5b1](https://github.com/firstlovecenter/fl-admin-portal/commit/44caa5b19463541028c31b13180cddf333f1aa33))
* **SetPermissions:**  add exclamation mark to initialization log for clarity ([e13ca4b7](https://github.com/firstlovecenter/fl-admin-portal/commit/e13ca4b75c99ac645c24aa1ac007238e3e399f4e))
* **AppWithApollo:**  remove sensitive token logging during access token retrieval ([643e28d2](https://github.com/firstlovecenter/fl-admin-portal/commit/643e28d2601668b28c91727e64b618a81d254c9d))
* **notification:**
  *  update email format to use HTML for Outside Accra Weekly Report ([dcfb7fd6](https://github.com/firstlovecenter/fl-admin-portal/commit/dcfb7fd6d378c17fd3f4fa1b3cd47f46d2909ac1))
  *  update recipient field format for Outside Accra Weekly Report ([8d71b7dd](https://github.com/firstlovecenter/fl-admin-portal/commit/8d71b7dd5fbed468fdab9e4d72990f997fbf0f0b))
* **handler:**  streamline error logging for SMS sending and clean up filename assignment ([397b85cd](https://github.com/firstlovecenter/fl-admin-portal/commit/397b85cddce447b156e3d03e58bcf6ae71d9c73a))
* **FileUpload:**  correct uploadToS3 function call by using an object for parameters ([429be658](https://github.com/firstlovecenter/fl-admin-portal/commit/429be65844a95c40168dae98b8b752940d81e661))

##### Other Changes

* **subset:**  shared currency formatter + drop TS any ([15dc5642](https://github.com/firstlovecenter/fl-admin-portal/commit/15dc56429e024ccf96d04c842d4a0d59331f88ff))
*  refetchQueries on every balance-changing mutation ([7e162898](https://github.com/firstlovecenter/fl-admin-portal/commit/7e162898a8875f2de38ae71768b6e5d76889c45a))
*  clientTransactionId MERGE idempotency end-to-end ([7253d888](https://github.com/firstlovecenter/fl-admin-portal/commit/7253d8882bd1621f2c2df8796466557904974398))
*  per-card lock + missing fragment key in Approvals ([164b9a85](https://github.com/firstlovecenter/fl-admin-portal/commit/164b9a85a0916518efcfe89a64353c3a731b0dc7))
*  cap transactions(limit) and index lastModified ([6be7f165](https://github.com/firstlovecenter/fl-admin-portal/commit/6be7f16533dba4b38879c2eccf2d2a4b1a42e9d5))
*  bussingAmount aggregates from ledger, not stale scalar ([dc73e2a7](https://github.com/firstlovecenter/fl-admin-portal/commit/dc73e2a753b74805f84cff4513916f33801a446a))
*  scope transaction reads with @churchScoped/@churchScopedVia ([9ba06a87](https://github.com/firstlovecenter/fl-admin-portal/commit/9ba06a87f3448ae777a01de97055cd60485f0a3c))
*  validate @neo4j/graphql v7 fixes the auth-filter recursion ([3158c340](https://github.com/firstlovecenter/fl-admin-portal/commit/3158c340266ac35b5e04b2b2daefa5468f5be280))
*  Enhance aggregate queries to include records from Bacenta for comprehensive data retrieval ([ac6aafa7](https://github.com/firstlovecenter/fl-admin-portal/commit/ac6aafa7760ba37a7b8534eefcf2f42ed2a24f57))
*  Improve aggregate service record query for better accuracy and performance ([bc36f217](https://github.com/firstlovecenter/fl-admin-portal/commit/bc36f217d3613883725e46c8b8e8173260fdc839))
*  Replace auth_id with userId in member matching queries in Cypher resolvers ([ca200b9f](https://github.com/firstlovecenter/fl-admin-portal/commit/ca200b9f44f47bebd476044936e689589e5bf63e))
*  remove campaign resolvers and schema from API" ([bced571a](https://github.com/firstlovecenter/fl-admin-portal/commit/bced571a410fdb5f572a5c0cccbf059f5cbf1b3d))
*  remove campaigns pages and routing from frontend" ([3a83afc7](https://github.com/firstlovecenter/fl-admin-portal/commit/3a83afc7411105b3f89f480620556aecbcbea233))
*  remove campaign integrations from services and dashboards" ([dce569cb](https://github.com/firstlovecenter/fl-admin-portal/commit/dce569cb7dba36c6c4055248bffe7c3bb000d1fb))
*  update meta.json version" ([315001b9](https://github.com/firstlovecenter/fl-admin-portal/commit/315001b919a7aa9809b765c8934390b0743d1bfc))

##### Performance Improvements

* **banking:**  label-scoped UNION + real fromStatus capture + indexes ([fc1ea322](https://github.com/firstlovecenter/fl-admin-portal/commit/fc1ea3222e8989d73a13f1060f330918e919bd08))
* **accounts:**  inline relationship projections to kill transactions N+1 ([abfb8e9c](https://github.com/firstlovecenter/fl-admin-portal/commit/abfb8e9c403a816913422ac06c9fc19731dfcdea))
* **directory:**  bump history page size to 50 initial / 25 incremental ([4f578790](https://github.com/firstlovecenter/fl-admin-portal/commit/4f5787900933aa85a96988516a7437b069d2d7ed))

##### Refactors

* **directory:**
  *  remove orphaned /directory dashboard page ([6f7e914b](https://github.com/firstlovecenter/fl-admin-portal/commit/6f7e914bb8272f4f9ee7cdddf581d7af177e0285))
  *  drop dead Churches page, rework PWA shortcuts ([d3e74b89](https://github.com/firstlovecenter/fl-admin-portal/commit/d3e74b897fbf7ad052ccb1ac78da5c13d9c38ecd))
  *  remove unused stream_name fields from GraphQL queries ([dc9979a9](https://github.com/firstlovecenter/fl-admin-portal/commit/dc9979a9e7226fafc1bac2e4dce40f5c2b2412c6))
  *  replace ServantMembers with ChurchLevelMembers ([2cfef798](https://github.com/firstlovecenter/fl-admin-portal/commit/2cfef798fb3e4dabcbc73831cf733800cec55cec))
  *  drop Greens/Reds tiles, surface per-bacenta tag ([0f40e450](https://github.com/firstlovecenter/fl-admin-portal/commit/0f40e4505db765f023afde354ab4d89e1aa3c34b))
  *  remove dead member-filter-utils after CSV migration ([e6a9e779](https://github.com/firstlovecenter/fl-admin-portal/commit/e6a9e779064dfc44baccae27fc228d8d763cf0e9))
  *  convert member grid files to TSX and inline load-more skeletons ([58e28637](https://github.com/firstlovecenter/fl-admin-portal/commit/58e28637fa40cfafd197f1ea055bddf675d45593))
  *  remove orphaned download-credits feature ([a21c3585](https://github.com/firstlovecenter/fl-admin-portal/commit/a21c3585ce0b3466b491cad0a49768662880be5f))
  *  style sub-church 'view all' link as ghost button ([b20128f1](https://github.com/firstlovecenter/fl-admin-portal/commit/b20128f1862c8d2387dcbda245fdafa68ffae40b))
  *  align member history with top 2-column grid ([6feecdef](https://github.com/firstlovecenter/fl-admin-portal/commit/6feecdef8097d6e6b15248246e7b26a058a5178c))
  *  redesign all-bacentas list page on shadcn ([061a8728](https://github.com/firstlovecenter/fl-admin-portal/commit/061a8728a8e1fee6148900776fd713c9cd3c17ac))
  *  redesign higher-level church details page ([75aae52a](https://github.com/firstlovecenter/fl-admin-portal/commit/75aae52a80eec281e1d75b38368a75344a3d4caf))
  *  redesign all church-history pages on shared view ([815d8e73](https://github.com/firstlovecenter/fl-admin-portal/commit/815d8e73dddf585b3ac4b0f02828aeffba6d21a8))
  *  inline bacenta bus payment edit as a dialog ([7d6c5d6a](https://github.com/firstlovecenter/fl-admin-portal/commit/7d6c5d6acb1270cf1a736a41272fe95f5a15ef0e))
* **web:**
  *  lift page headers into StickyPageHeader to clear PWA chrome ([165a02c7](https://github.com/firstlovecenter/fl-admin-portal/commit/165a02c784066f68bf9c3213017a2f74f5f62844))
  *  adopt StickyPageHeader across remaining 12 pages ([b31d8d92](https://github.com/firstlovecenter/fl-admin-portal/commit/b31d8d92e47432bdf9006e1912c5f82919c0aaa8))
  *  migrate react-bootstrap to shadcn/ui (SYN-128..142) ([58adb4bd](https://github.com/firstlovecenter/fl-admin-portal/commit/58adb4bd1c6715ede91690fd9a8214420d280216))
  *  replace html2canvas+jsPDF with browser print route ([3e3efb54](https://github.com/firstlovecenter/fl-admin-portal/commit/3e3efb54f04f2ccc699c6539b241555a8001e46b))
  *  drop dead stream_name selections from queries ([4a1e2687](https://github.com/firstlovecenter/fl-admin-portal/commit/4a1e26872ac12d7464d57a43033e265f6c38a2d0))
  *  remove church-list selection pages ([7db5b894](https://github.com/firstlovecenter/fl-admin-portal/commit/7db5b8945d3946e83529611e17174c2c4651973f))
  *  drop redundant back buttons from download pages ([291b53f3](https://github.com/firstlovecenter/fl-admin-portal/commit/291b53f39a0c4361ab1af4a269e1752164c89b23))
  *  replace react-simple-pull-to-refresh with in-repo component ([eca14caa](https://github.com/firstlovecenter/fl-admin-portal/commit/eca14caad1cc61b26130b71fb7a05bb99373dd25))
* **deps:**  inline jd-date-utils and drop the dep (SYN-61) ([90700855](https://github.com/firstlovecenter/fl-admin-portal/commit/907008551160661c4d4dc7f5e4ac129eb8da5261))
* **banking:**
  *  rename anagkazo/ to manual-banking/ + URL redirect ([fb5dd314](https://github.com/firstlovecenter/fl-admin-portal/commit/fb5dd314693192d51655946164780b8948f874a9))
  *  central TRANSACTION_STATUS const + BANKING_METHOD types ([23522b78](https://github.com/firstlovecenter/fl-admin-portal/commit/23522b782e9ed28c8e7490a08cb1e1c55969a960))
  *  migrate banking-slip pages to Shadcn + Tailwind ([60563cc1](https://github.com/firstlovecenter/fl-admin-portal/commit/60563cc1d454ed9257bed36244d7fcedcd1506e2))
  *  drop unused mutation args, stop sending dead form fields ([e361bd89](https://github.com/firstlovecenter/fl-admin-portal/commit/e361bd897b83f1aa00bdd6400747eea7615a1362))
  *  migrate slip pages to shadcn and dedupe via shared list ([7d2cf36e](https://github.com/firstlovecenter/fl-admin-portal/commit/7d2cf36ea07fef62c1ac07491e75d00f5b26999e))
* **services:**
  *  memoize membership download preview rows ([080f5e35](https://github.com/firstlovecenter/fl-admin-portal/commit/080f5e35d38e026aca0ec785e4315d020d73d9bc))
  *  migrate OversightByCampus to Shadcn + Tailwind ([ba32b502](https://github.com/firstlovecenter/fl-admin-portal/commit/ba32b502a244fadc7d99f3e40ca19bd0fd0bc53a))
  *  delete dead per-level joint pages and routes ([26466cb1](https://github.com/firstlovecenter/fl-admin-portal/commit/26466cb15d2a349e012223d90d1ca8e24422eec0))
  *  redesign filled-services page on shadcn + tailwind ([5f5de025](https://github.com/firstlovecenter/fl-admin-portal/commit/5f5de02563def1de162a658eca3aa0a0bcf6df5e))
* **dashboards:**  generalize counter nav hide flag, gate URL access ([cd09f1db](https://github.com/firstlovecenter/fl-admin-portal/commit/cd09f1db2ecd14575d62397f938d33e389d70494))
* **arrivals:**
  *  close ConfirmVehicleByAdmin session in finally ([9cbc0274](https://github.com/firstlovecenter/fl-admin-portal/commit/9cbc0274b532f59a5bfd5aa4d13c1e6500be2ec1))
  *  redesign bacentas-to-count for mobile ([206d9b6c](https://github.com/firstlovecenter/fl-admin-portal/commit/206d9b6c9c9cc793e1eac5c422d7eff9e16b2623))
  *  update ArrivalsHeader to remove sticky behavior on mobile ([dffcb3fb](https://github.com/firstlovecenter/fl-admin-portal/commit/dffcb3fb0a358aec3ab71656ad382a9d74a52dee))
  *  migrate council-by-governorship to shadcn ([8cfdfa23](https://github.com/firstlovecenter/fl-admin-portal/commit/8cfdfa2303c938ea37da8439c52d06a708f57320))
  *  tidy state pages after skeleton extraction ([e3d18241](https://github.com/firstlovecenter/fl-admin-portal/commit/e3d18241367210b8d6035749eed8ff7c0515046e))
  *  replace inline ListSkeleton in StateBacentasArrived ([a06ed1b9](https://github.com/firstlovecenter/fl-admin-portal/commit/a06ed1b9dcc13f5bb9ef67a50b1544d1781a6e2a))
  *  replace inline ListSkeleton with shared BacentaListSkeleton ([eab51bf2](https://github.com/firstlovecenter/fl-admin-portal/commit/eab51bf20d6c9b125a775e7d2685d3e740bac1d4))
  *  remove comments and arrival time from bussing records ([d26d1f0f](https://github.com/firstlovecenter/fl-admin-portal/commit/d26d1f0f7773981f0d56525ad4bca07cae5ade09))
* **accounts:**  lift SetCouncilHRAmount + DeclineExpense to resolvers (SYN-96) ([0b7c6767](https://github.com/firstlovecenter/fl-admin-portal/commit/0b7c6767d5517ba2a33bb7097b0a87c4050df4ca))
*  remove residual Creative Arts parallel hierarchy ([80fd2f83](https://github.com/firstlovecenter/fl-admin-portal/commit/80fd2f830096d881b9128c39e072ac199d677526))
*  remove residual Creative Arts hierarchy references ([a9ee44e9](https://github.com/firstlovecenter/fl-admin-portal/commit/a9ee44e9e5abb5bdc97d95318858f01cafe4a665))
*  remove Creative Arts hierarchy dead code ([8c62fff1](https://github.com/firstlovecenter/fl-admin-portal/commit/8c62fff1532b0b05927a60350849779e5e7ad428))
*  remove Fellowship hierarchy dead code (Bacenta is leaf node) ([a849f2fa](https://github.com/firstlovecenter/fl-admin-portal/commit/a849f2fa1434f80d6d7e96110c1064cb893e1a7a))
*  improve code formatting and readability across multiple components ([84e8dd59](https://github.com/firstlovecenter/fl-admin-portal/commit/84e8dd59fe9646b4414c05af69938e60c0289b78))
*  Clean up imports and improve console log formatting in Outside Accra Weekly handler ([e46b3178](https://github.com/firstlovecenter/fl-admin-portal/commit/e46b31782d7ccc38bf7b8c61fcc0733daf38ab09))
*  Update fellowship mode date handling to use last Sunday or report date ([e21dcb6b](https://github.com/firstlovecenter/fl-admin-portal/commit/e21dcb6b2f8e2014b290e843e5734a8127ac74ca))
*  Update fellowship mode date handling to use last Sunday or report date ([d3d2db0f](https://github.com/firstlovecenter/fl-admin-portal/commit/d3d2db0ff8de64b73647175b3c70b838452cec93))
*  Remove unused matchMemberAndIMCLStatus query from directory resolvers ([c89959e5](https://github.com/firstlovecenter/fl-admin-portal/commit/c89959e533d242579d2621bad2b46b7f95f1adbe))
*  Update confirmation and alert messages for removing arrivals counters ([54174737](https://github.com/firstlovecenter/fl-admin-portal/commit/541747379de5910ca710a3934651e86cf0b22942))
*  Remove test query from Neo4j connection verification and adjust jwt logging ([d78b42ad](https://github.com/firstlovecenter/fl-admin-portal/commit/d78b42ade44f021bc00b921efabe164ab8189233))
*  Enhance parameter extraction in handler to include event source ([27ea228d](https://github.com/firstlovecenter/fl-admin-portal/commit/27ea228df7f96ea74714aa29d1516221bd3c0f94))
*  Update income query functions to accept lastSunday parameter and improve date handling ([710802f2](https://github.com/firstlovecenter/fl-admin-portal/commit/710802f29087fec3550301d601f2f399175df836))
*  Update auth_id references to use userId for consistency across resolvers and Cypher queries ([cb1988d2](https://github.com/firstlovecenter/fl-admin-portal/commit/cb1988d29b998932cab93b1b0cd47b9ee0797940))
*  Update member creation to include User label in Cypher queries ([f885cec1](https://github.com/firstlovecenter/fl-admin-portal/commit/f885cec1d0097115d219003e3f4f1e4ca38e00a5))
*  Remove console logs for cleaner code in AppWithContext, SetPermissions, AuthContext, and AppWithApollo ([5bd8d8ac](https://github.com/firstlovecenter/fl-admin-portal/commit/5bd8d8acfaa9b0e9ca9208c06191db9917741541))
*  Remove console logs from SimpleApp for cleaner code ([24276d9d](https://github.com/firstlovecenter/fl-admin-portal/commit/24276d9d8c780592f296001d2c8c9cf65b9baa8c))
*  Implement create operations for Governorship, Council, Stream, Campus, and Oversight in GraphQL schema and resolvers ([e95196c3](https://github.com/firstlovecenter/fl-admin-portal/commit/e95196c3fffe02b3dd23cd80573296a32e5804a1))
*  Implement CreateBacenta mutation and associated GraphQL schema, removing legacy code ([3b65a590](https://github.com/firstlovecenter/fl-admin-portal/commit/3b65a5903da85b4e1a67ff063f2d916e1147c501))
*  Add member fields to return queries and comment out directory lock validation ([c372c02c](https://github.com/firstlovecenter/fl-admin-portal/commit/c372c02c1fa3d5e8fe92c950d66ec408cb73799b))
*  Remove UpdateMemberEmail mutation and related code from directory resolvers and components ([#498](https://github.com/firstlovecenter/fl-admin-portal/pull/498)) ([c9748448](https://github.com/firstlovecenter/fl-admin-portal/commit/c9748448eb01dc9c134ca7ab01085b3d276ac9c7))
*  Remove auth_id field from various Cypher queries and TypeScript interfaces ([f2392ee6](https://github.com/firstlovecenter/fl-admin-portal/commit/f2392ee62e6a00040fb854e182e5dcee7b4a542d))
*  Update Member authentication field from auth_id to id in various Cypher queries and GraphQL schemas ([#497](https://github.com/firstlovecenter/fl-admin-portal/pull/497)) ([98bbd31f](https://github.com/firstlovecenter/fl-admin-portal/commit/98bbd31ffb2d0d4e40c1ae024cb50151d57c771d))
*  Improve public route handling and logging in SimpleApp and SetPermissions components ([890f6712](https://github.com/firstlovecenter/fl-admin-portal/commit/890f671285bfb3dfe889d77a1d299ca1b947ba35))
*  Enhance validateServant function to handle undefined cases and improve type safety ([03f41e5b](https://github.com/firstlovecenter/fl-admin-portal/commit/03f41e5bfe708eea08838cf95353667ad0de0c2a))
*  Improve JWT authentication handling comment for clarity ([95e92f0d](https://github.com/firstlovecenter/fl-admin-portal/commit/95e92f0dfa8bb4918c94d6eb7fe922151d3d4957))
*  Improve session management and error handling in servant operations ([38911da3](https://github.com/firstlovecenter/fl-admin-portal/commit/38911da301c76c1b856904b0d00d57d8a163753e))
*  update image upload components to use S3 and remove Cloudinary dependencies ([569011d3](https://github.com/firstlovecenter/fl-admin-portal/commit/569011d3dc532ac68c08d7e0442916965077a8a9))
*  remove SheepSeeker references and related code across the application ([09f9cf20](https://github.com/firstlovecenter/fl-admin-portal/commit/09f9cf20718394db086fb262fe498c43849ff72b))
*  remove unused components and related code for Swollen Sunday campaign ([57976682](https://github.com/firstlovecenter/fl-admin-portal/commit/57976682aecacbfc3ee3cb922bcbd4409494ec22))
*  remove vercel configuration file ([1f901a2a](https://github.com/firstlovecenter/fl-admin-portal/commit/1f901a2a7bf2e5a3c6a692db7dd84227c692d580))
*  remove campaign integrations from services and dashboards ([2eb96459](https://github.com/firstlovecenter/fl-admin-portal/commit/2eb9645982e2fa0bfa64bdac81e8030e8f84e433))
*  remove campaigns pages and routing from frontend ([26769d1b](https://github.com/firstlovecenter/fl-admin-portal/commit/26769d1bfff0a24c6b65cd25daf20fb09dd86570))
*  remove campaign resolvers and schema from API ([8970ae88](https://github.com/firstlovecenter/fl-admin-portal/commit/8970ae882236edb1e88b552a71166d4b4f0fb5cf))
*  simplify account open logic by removing unused day checks ([817cf213](https://github.com/firstlovecenter/fl-admin-portal/commit/817cf213b7f6a590420750140e955585c7fcfd2c))
* **reports:**  align weekly download card with two-column layout ([ba9990f8](https://github.com/firstlovecenter/fl-admin-portal/commit/ba9990f89768f58f3529cce7567e4b063e538c65))
* **SetPermissions:**  simplify memberData property access ([36ac4749](https://github.com/firstlovecenter/fl-admin-portal/commit/36ac47492a45d7ef43be0faadac37c429dc9da4e))
* **index:**  remove unused imports from index.tsx ([534f53c4](https://github.com/firstlovecenter/fl-admin-portal/commit/534f53c4b8fb3fed32d5fd07df3b5c6f600dd034))

##### Code Style Changes

* **arrivals:**
  *  skeleton-load stream counters page ([a85eecbc](https://github.com/firstlovecenter/fl-admin-portal/commit/a85eecbca0974371a0e45a9d32b6570406e51e49))
  *  put summary above counters list on mobile ([d33b8650](https://github.com/firstlovecenter/fl-admin-portal/commit/d33b86500e37551a8f2f65b5a91ac63caeee732f))
  *  compress stream, governorship, campus dashboards above fold ([d41be1c5](https://github.com/firstlovecenter/fl-admin-portal/commit/d41be1c598703e7028b3cad5da6742cb1a32c011))
  *  migrate stream arrivals counters to Shadcn/Tailwind ([7f7e086f](https://github.com/firstlovecenter/fl-admin-portal/commit/7f7e086f588ad4af184953877472aaba3a8c43c8))
  *  redesign payment-data page with 2-col sidebar layout ([4235a4b4](https://github.com/firstlovecenter/fl-admin-portal/commit/4235a4b48845dbca8c6e9a78fc9c6a7c9c095f79))
  *  compress council dashboard so bacenta status fits above fold ([6db79e5c](https://github.com/firstlovecenter/fl-admin-portal/commit/6db79e5ca49ebc4240f76ed7d3b26bc82cb1192b))
* **services:**
  *  migrate StreamByCouncil to Shadcn/Tailwind ([1d120cd4](https://github.com/firstlovecenter/fl-admin-portal/commit/1d120cd4ccbaa04c9d424acd60a51aec17e4839d))
  *  two-column desktop layout for ServicesMenu ([9b9ebfa2](https://github.com/firstlovecenter/fl-admin-portal/commit/9b9ebfa25fabb6a2b9be3d790dc5e8aa10d56d2e))
* **dashboards:**  tint not-due-yet button with muted brand color ([491b0743](https://github.com/firstlovecenter/fl-admin-portal/commit/491b07435818613218dd750330dd2829550fafba))
* **web:**
  *  compress mobile sidenav items for tighter layout ([97effc9b](https://github.com/firstlovecenter/fl-admin-portal/commit/97effc9b1be8d68f917db1c7dba7f0008bbf83f4))
  *  two-column desktop layout for reports and trends menus ([dc09aaf8](https://github.com/firstlovecenter/fl-admin-portal/commit/dc09aaf867caa8821dc9750d7cdb4261c7269949))
* **reports:**  add lift animation to report cards on hover ([4b0058b1](https://github.com/firstlovecenter/fl-admin-portal/commit/4b0058b1b2d008060f7ff9861823f18ff6edf1f9))
* **schema:**  remove stale @churchScoped directive comments ([8ef082b5](https://github.com/firstlovecenter/fl-admin-portal/commit/8ef082b556d8a07fda8cb8e6b88ad31c9f1c5527))
* **directory:**  apply mandatory heading convention to bacenta quick-facts ([89af81ee](https://github.com/firstlovecenter/fl-admin-portal/commit/89af81ee5cdd5bd8b3951924010c42622a4a876d))
*  enforce consistent heading styles across pages and components ([02ecf45c](https://github.com/firstlovecenter/fl-admin-portal/commit/02ecf45c07eaf2a11e5a7643489bef5eb0dea12c))

##### Tests

* **arrivals:**  pin SM5 ConfirmVehicleByAdmin mocks to SDL shape ([728e6c33](https://github.com/firstlovecenter/fl-admin-portal/commit/728e6c33e3e363f9221e2ff99c4a7be10f925b7f))
* **web:**
  *  characterize apollo client link chain via msw ([2c603d66](https://github.com/firstlovecenter/fl-admin-portal/commit/2c603d665b43ecc162c6fef42e306e7c90107ee9))
  *  remove broken legacy test files (jest-dom extend-expect) ([be70e5a5](https://github.com/firstlovecenter/fl-admin-portal/commit/be70e5a51755c632b6bb0dea590df8f774948726))
* **accounts:**  add validation and undo mutation tests for SYN-87 ([b291f665](https://github.com/firstlovecenter/fl-admin-portal/commit/b291f665b67bb5f7670a65ea949485430575bee0))
*  close SYN-121/122 — approve/decline/recordService no-HistoryLog is by design ([15379af2](https://github.com/firstlovecenter/fl-admin-portal/commit/15379af2e4436ef33624bf439ef236416eccd8a0))
*  add SYN-80/81/82 coverage and ADR-012 ESLint enforcement ([405a992b](https://github.com/firstlovecenter/fl-admin-portal/commit/405a992b9c6741140fe522c7e15e440408a6c9a0))
* **api:**
  *  characterization tests for W4, W5, SM1 (SYN-73/74/77) ([318c4893](https://github.com/firstlovecenter/fl-admin-portal/commit/318c4893db51b34a70d31bd7904e1a17a7302e91))
  *  characterization tests for SM5, SM6, W1 (SYN-70/71/72) ([07abaaf0](https://github.com/firstlovecenter/fl-admin-portal/commit/07abaaf0024fd2d40f5d39eb9687930c1011426e))
  *  characterization tests for SM2, SM3, SM4 state machines ([e776c49e](https://github.com/firstlovecenter/fl-admin-portal/commit/e776c49e86f3179eefa83edf1fb7577890494f0e))
* **banking:**  add SM1 characterization tests for transactionStatus idempotency ([214f4ba8](https://github.com/firstlovecenter/fl-admin-portal/commit/214f4ba8f921fc7a4cf3e0c87794db9c71534fee))
* **utils:**  add unit tests for isAuth and throwToSentry functions ([995c98cf](https://github.com/firstlovecenter/fl-admin-portal/commit/995c98cfa28b754c53676b89026b8471f79e3051))
* **lambda:**
  *  lock down bacenta-graph-aggregator ADR-014 invariants (SYN-76) ([0e4c69b2](https://github.com/firstlovecenter/fl-admin-portal/commit/0e4c69b281d6e691af9f648f4d17b7dd1ebfc678))
  *  lock down service-graph-aggregator ADR-014 invariants ([42aa6aa5](https://github.com/firstlovecenter/fl-admin-portal/commit/42aa6aa50b9a3e78d2354e1bb7574bea877e6782))
* **auth:**
  *  add AuthContext token lifecycle tests (SYN-65) ([090a4278](https://github.com/firstlovecenter/fl-admin-portal/commit/090a427837a16a59d14ee4a5dc399993951a71c6))
  *  add ProtectedRoute + RoleView characterization tests (SYN-78) ([54ae0c46](https://github.com/firstlovecenter/fl-admin-portal/commit/54ae0c46a1548b67b04fb8e913287ee4efb7b2b0))
  *  expand permission-helper mirror suite (SYN-63) ([fe5d7b2a](https://github.com/firstlovecenter/fl-admin-portal/commit/fe5d7b2aa13310a197dc815bb4df12435734cca3))
