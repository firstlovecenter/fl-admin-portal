...
exports.aggregateHubRehearsalDataForMinistry = exports.aggregateHubRehearsalDataForHubCouncil = exports.aggregateMinistryMeetingDataForCreativeArts = exports.aggregateMinistryMeetingDataForMinistry = exports.aggregateMinistryMeetingDataForHubCouncil = exports.aggregateMinistryMeetingDataForHub = exports.recordCancelledOnStagePerformance = exports.recordCancelledService = exports.recordOnStageAttendance = exports.recordHubRehearsalService = exports.recordSundayMinistryAttendance = exports.checkMinistryStageAttendanceFormFilledThisWeek = exports.checkMinistryAttendanceFormFilledThisWeek = exports.getServantAndChurch = exports.checkCurrentServiceLog = exports.checkStreamServiceDay = exports.checkRehearsalFormFilledThisWeek = void 0;
exports.checkRehearsalFormFilledThisWeek = `
...
`;
exports.checkCurrentServiceLog = `
MATCH (church {id:$churchId}) 
WHERE church:Hub OR church:HubCouncil OR church:Ministry
MATCH (church)-[:CURRENT_HISTORY]->(log:ServiceLog)
RETURN true AS exists
`;
exports.getServantAndChurch = `
MATCH (church {id: $churchId}) 
WHERE church:Hub OR church:HubCouncil OR church:Ministry
...
`;
exports.checkMinistryAttendanceFormFilledThisWeek = `
    MATCH (church {id: $churchId})
    ...
    RETURN church.id AS id, church.name AS name, labels(church) AS labels, labels(higherChurch) AS higherChurchLabels, higherChurch.id AS higherChurchId, record IS NOT NULL AS alreadyFilled
    `;
exports.checkMinistryStageAttendanceFormFilledThisWeek = `
MATCH (church {id: $churchId})
...
RETURN church.id AS id, church.name AS name, labels(church) AS labels, labels(higherChurch) AS higherChurchLabels, higherChurch.id AS higherChurchId, record IS NOT NULL AS alreadyFilled
`;
exports.recordSundayMinistryAttendance = `
...
`;
exports.recordHubRehearsalService = `
...
`;
exports.recordOnStageAttendance = `
...
`;
exports.recordCancelledService = `
...
`;
exports.recordCancelledOnStagePerformance = `
...
exports.aggregateMinistryMeetingDataForHubCouncil = `
    ...
    RETURN creativeArt, aggregate
`;
exports.aggregateMinistryMeetingDataForMinistry = `
    ...
    RETURN creativeArt, aggregate
`;
exports.aggregateMinistryMeetingDataForCreativeArts = `
    ...
    RETURN creativeArt, aggregate
`;
exports.aggregateHubRehearsalDataForHubCouncil = `
    MATCH (hub:Hub {id: $churchId})
    WITH hub as lowerChurch
    MATCH (lowerChurch)<-[:HAS]-(hubcouncil:HubCouncil)
...
`;
exports.aggregateHubRehearsalDataForMinistry = `
