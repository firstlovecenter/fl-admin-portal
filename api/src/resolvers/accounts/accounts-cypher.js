...
exports.depositIntoCoucilBussingSociety = exports.depositIntoCouncilCurrentAccount = exports.debitBussingSociety = exports.approveExpense = exports.creditBussingSocietyFromWeekday = exports.approveBussingExpense = exports.getCouncilBalances = exports.getCouncilBalancesWithTransaction = void 0;
exports.getCouncilBalancesWithTransaction = `
...
`;
exports.getCouncilBalances = `
MATCH (council:Council {id: $councilId})
MATCH (council)<-[:LEADS]-(leader:Member)
RETURN council, leader
`;
exports.approveBussingExpense = `
MATCH (transaction:AccountTransaction {id: $transactionId})<-[:HAS_TRANSACTION]-(council:Council)
...
`;
exports.creditBussingSocietyFromWeekday = `
...
exports.depositIntoCouncilCurrentAccount = `
MATCH (council:Council {id: $councilId})
...
RETURN council, transaction, depositor
`;
exports.depositIntoCoucilBussingSociety = `
   MATCH (council:Council {id: $councilId})
   MATCH (depositor:Member {auth_id: $jwt.sub})
