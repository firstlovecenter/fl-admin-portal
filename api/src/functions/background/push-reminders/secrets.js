...
/**
 * Loads secrets from AWS Secrets Manager. Mirrors the weekly-tip-generator
...
const loadSecrets = async () => {
  ...
  try {
    ...
    try {
      ...
      // Never rethrow the parse error itself — V8's JSON.parse messages embed
      // a snippet of the (secret) source string, which would land in CloudWatch.
